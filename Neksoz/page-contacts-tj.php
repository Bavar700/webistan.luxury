        ...
        <div class="container hero__container" style="position:relative;z-index:2;">
            <div class="hero__content">
                ...
                <h1 class="hero__title">
                    Бо коршиносони Нексоз тамос гиред
                </h1>
                <p class="hero__desc">
        ...
        <div class="container fade-up">
            ...
            <div class="cta-crystal__grid" style="align-items: stretch; gap: 40px;">
                ...
                <div style="display: flex; flex-direction: column; gap: 30px; flex: 1; position: relative; z-index: 2;">
                    ...
                    <!-- Card 1: Маълумоти асосӣ -->
                    <div class="contact-card">
                        <h3 class="cta-crystal__title" style="font-size: 28px; margin-top: 0; margin-bottom: 24px; text-transform: none; color: var(--nk-gray-900);">Маълумоти асосӣ</h3>
                ...
                <div style="background: rgba(255, 255, 255, 0.8); border: 1px solid rgba(0, 13, 51, 0.05); border-radius: 32px; padding: 50px; box-shadow: 0 40px 100px rgba(0, 13, 51, 0.06); backdrop-filter: blur(20px); -webkit-backdrop-filter: blur(20px); flex: 1.2; position: relative; z-index: 2; display: flex; flex-direction: column; height: 100%;">
                    <h3 class="cta-crystal__title" style="font-size: 28px; margin-bottom: 12px; margin-top: 0;">Тиҷорати шуморо баррасӣ кунем?</h3>
                    <p style="color: var(--nk-gray-600); margin-bottom: 40px; font-size: 15px; line-height: 1.6;">Формаи зеринро пур кунед ва мо барои шумо пешниҳоди инфиродӣ омода мекунем.</p>
            ...
            <div style="margin-top: 60px; text-align: center;">
                <span style="font-size: 16px; color: var(--nk-gray-600); font-weight: 500; display: block; margin-bottom: 20px;">Мо дар шабакаҳои иҷтимоӣ:</span>
