...
class Map extends Base_Widget {
	...
	protected function register_controls() {
		...
		$this->add_control( 'ts_gesture_handling', [
			'label' => __( 'Gesture handling', 'voxel-elementor' ),
			'description' => __( 'Cooperative mode requires Ctrl+scroll to zoom and two-finger drag on mobile, preventing the map from hijacking page scroll.', 'voxel-elementor' ),
			'type' => \Elementor\Controls_Manager::SELECT,
			'default' => 'greedy',
			'options' => [
				'greedy' => __( 'Greedy', 'voxel-elementor' ),
				'cooperative' => __( 'Cooperative', 'voxel-elementor' ),
			],
		] );
	...
	public function get_style_depends() {
		...
		if ( \Voxel\get( 'settings.maps.provider' ) === 'mapbox' && ! \Voxel\is_preview_mode() ) {
			...
			$styles[] = 'leaflet';
			$styles[] = 'leaflet-fullscreen';
			$styles[] = 'leaflet-gesture-handling';
		}
