    ...
    <section class="hero hero--internal">
        ...
        <div class="container hero__container" style="position:relative;z-index:2;">
            <div class="hero__content">
                <div class="hero__badge">Цифровая трансформация</div>
                <h1 class="hero__title">
                    <span class="text-gradient">Автоматизация</span><br>бизнес-процессов
                </h1>
                <p class="hero__desc">
                    Освобождение команды от рутины и исключение человеческого фактора через внедрение современных цифровых решений.
                </p>
            </div>
            
            <div class="hero__actions--right">
                <a href="#lead-form" class="cta-crystal__btn" style="padding: 18px 50px; font-size: 13px;">
                    <span>Ускорить работу</span>
        ...
        <div class="container">
            ...
            <div class="services-grid" style="grid-template-columns: repeat(2, 1fr); gap: 40px;">
                ...
                <div class="service-card service-card--alt" style="height: 100%;">
                    ...
                    <h3 class="service-card__title">Когда нужна <br>автоматизация?</h3>
