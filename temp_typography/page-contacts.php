...
<main class="site-main">
        ...
        <div class="container hero__container" style="position:relative;z-index:2;">
            ...
            <div class="hero__actions--right">
                <a href="tel:+992985641010" class="btn btn--primary btn-animated">
                    ÐŸÐ¾Ð·Ð²Ð¾Ð½Ð¸Ñ‚ÑŒ ÑÐµÐ¹Ñ‡Ð°Ñ
    ...
    <!-- â•â•â•â•â•â•â•â•â•â•â• CONTACT GRID & FORM â•â•â•â•â•â•â•â•â•â•â• -->
    <section class="section cta-crystal" style="padding-top: 80px; padding-bottom: 120px;">
        ...
        <div class="container fade-up">
            ...
            <div class="section__header section__header--center" style="margin-bottom: 60px;">
                <div class="section__label">ÐŸÑ€ÑÐ¼Ð¾Ð¹ ÐºÐ¾Ð½Ñ‚Ð°ÐºÑ‚</div>
                <h2 class="section__title">ÐžÑ‚ÐºÑ€Ñ‹Ñ‚Ñ‹ Ðº Ð´Ð¸Ð°Ð»Ð¾Ð³Ñƒ</h2>
                <p class="section__subtitle">Ð’Ñ‹Ð±ÐµÑ€Ð¸Ñ‚Ðµ ÑƒÐ´Ð¾Ð±Ð½Ñ‹Ð¹ ÑÐ¿Ð¾ÑÐ¾Ð± ÑÐ²ÑÐ·Ð¸ Ð¸Ð»Ð¸ Ð¾ÑÑ‚Ð°Ð²ÑŒÑ‚Ðµ Ð¿Ñ€ÑÐ¼Ð¾Ð¹ Ð·Ð°Ð¿Ñ€Ð¾Ñ Ð² Ð½Ð°Ñˆ ÐºÐ¾Ð½ÑÐ°Ð»Ñ‚Ð¸Ð½Ð³Ð¾Ð²Ñ‹Ð¹ Ð¾Ñ‚Ð´ÐµÐ».</p>
            </div>
            ...
            <div class="cta-crystal__grid" style="align-items: stretch;">
                ...
                <div style="background: var(--nk-white); border: 1px solid var(--nk-gray-50); border-radius: 32px; padding: 50px; box-shadow: 0 10px 30px rgba(0, 13, 51, 0.03); display: flex; flex-direction: column; gap: 40px; position: relative; z-index: 2;">
                    ...
                    <div>
                        <h3 class="cta-crystal__title" style="font-size: 28px; margin-bottom: 24px; text-transform: none; color: var(--nk-gray-900);">ÐžÑÐ½Ð¾Ð²Ð½Ð°Ñ Ð¸Ð½Ñ„Ð¾Ñ€Ð¼Ð°Ñ†Ð¸Ñ</h3>
                        <ul style="list-style: none; padding: 0;">
                            <li class="contact-item">
                                ...
                                <div style="padding-top: 4px;">
                                    <strong style="display: block; color: var(--nk-gray-900); font-size: 16px; margin-bottom: 6px; font-weight: 600;">ÐÐ´Ñ€ÐµÑ:</strong>
                                    <span style="color: var(--nk-gray-600); line-height: 1.6; font-size: 15px;">734000, Ð ÐµÑÐ¿ÑƒÐ±Ð»Ð¸ÐºÐ° Ð¢Ð°Ð´Ð¶Ð¸ÐºÐ¸ÑÑ‚Ð°Ð½,<br>Ð³. Ð”ÑƒÑˆÐ°Ð½Ð±Ðµ, Ð¿Ñ€Ð¾ÑÐ¿ÐµÐºÑ‚ Ð ÑƒÐ´Ð°ÐºÐ¸ 55, 3-ÑÑ‚Ð°Ð¶.</span>
                                    <span style="display: block; font-size: 13px; color: var(--nk-gray-400); margin-top: 6px;">(ÐžÑ€Ð¸ÐµÐ½Ñ‚Ð¸Ñ€: Ð¦ÐµÐ½Ñ‚Ñ€ Ð³Ð¾Ñ€Ð¾Ð´Ð°)</span>
                                </div>
                            </li>
                            <li class="contact-item">
                                <div class="contact-icon">
                                ...
                                <div style="padding-top: 14px;">
                                    <strong style="display: block; color: var(--nk-gray-900); font-size: 16px; margin-bottom: 6px; font-weight: 600;">Ð¢ÐµÐ»ÐµÑ„Ð¾Ð½:</strong>
                    ...
                    <!-- 2. Ð ÐµÐ¶Ð¸Ð¼ Ñ€Ð°Ð±Ð¾Ñ‚Ñ‹ -->
                    <div>
                        <h3 class="cta-crystal__title" style="font-size: 24px; margin-bottom: 16px; text-transform: none; color: var(--nk-gray-900);">Ð ÐµÐ¶Ð¸Ð¼ Ñ€Ð°Ð±Ð¾Ñ‚Ñ‹</h3>
                        <p style="color: var(--nk-gray-600); line-height: 1.6; margin-bottom: 20px; font-size: 15px;">ÐœÑ‹ Ñ†ÐµÐ½Ð¸Ð¼ Ð²Ð°ÑˆÐµ Ð²Ñ€ÐµÐ¼Ñ Ð¸ Ð¿Ñ€Ð¸Ð´ÐµÑ€Ð¶Ð¸Ð²Ð°ÐµÐ¼ÑÑ ÑÑ‚Ñ€Ð¾Ð³Ð¾Ð³Ð¾ Ð³Ñ€Ð°Ñ„Ð¸ÐºÐ°:</p>
                        <div style="background: rgba(0, 13, 51, 0.02); border: 1px solid rgba(0, 13, 51, 0.05); border-radius: 12px; padding: 24px;">
                            <div style="display: flex; justify-content: space-between; margin-bottom: 12px; padding-bottom: 12px; border-bottom: 1px dashed rgba(0, 13, 51, 0.1);">
                                <span style="color: var(--nk-gray-700);">ÐŸÐ½ â€“ ÐŸÑ‚</span>
                                <strong style="color: var(--nk-gray-900);">09:00 â€“ 18:00</strong>
                            </div>
                            <div style="display: flex; justify-content: space-between; margin-bottom: 12px; padding-bottom: 12px; border-bottom: 1px dashed rgba(0, 13, 51, 0.1);">
                                <span style="color: var(--nk-gray-700);">Ð¡ÑƒÐ±Ð±Ð¾Ñ‚Ð°</span>
                                <strong style="color: var(--nk-gray-900);">10:00 â€“ 14:00</strong>
                            </div>
                            <div style="display: flex; justify-content: space-between;">
                                <span style="color: var(--nk-gray-700);">Ð’Ð¾ÑÐºÑ€ÐµÑÐµÐ½ÑŒÐµ</span>
                                <span style="color: var(--nk-red); font-weight: 500;">Ð’Ñ‹Ñ…Ð¾Ð´Ð½Ð¾Ð¹</span>
                            </div>
                        </div>
                    </div>

                    <!-- 4. Ð¡Ð¾Ñ†Ð¸Ð°Ð»ÑŒÐ½Ñ‹Ðµ ÑÐµÑ‚Ð¸ -->
                    <div>
                        ...
                        <div style="display: flex; gap: 12px; flex-wrap: wrap;">
                            ...
                            <a href="tel:+992446000000" class="social-icon-wrapper" title="ÐŸÐ¾Ð·Ð²Ð¾Ð½Ð¸Ñ‚ÑŒ">
                ...
                <div style="background: rgba(255, 255, 255, 0.8); border: 1px solid rgba(0, 13, 51, 0.05); border-radius: 32px; padding: 50px; box-shadow: 0 40px 100px rgba(0, 13, 51, 0.06); backdrop-filter: blur(20px); -webkit-backdrop-filter: blur(20px); display: flex; flex-direction: column; justify-content: flex-start; position: relative; z-index: 2;">
                    <h3 style="font-size: 28px; color: var(--nk-gray-900); font-family: var(--font-display); font-weight: 800; margin-bottom: 12px; margin-top: 0; letter-spacing: -0.02em;">ÐžÐ±ÑÑƒÐ´Ð¸Ð¼ Ð²Ð°Ñˆ Ð±Ð¸Ð·Ð½ÐµÑ?</h3>
                    <p style="color: var(--nk-gray-600); margin-bottom: 40px; font-size: 15px; line-height: 1.6;">Ð—Ð°Ð¿Ð¾Ð»Ð½Ð¸Ñ‚Ðµ Ñ„Ð¾Ñ€Ð¼Ñƒ Ð½Ð¸Ð¶Ðµ, Ð¸ Ð¼Ñ‹ Ð¿Ð¾Ð´Ð³Ð¾Ñ‚Ð¾Ð²Ð¸Ð¼ Ð´Ð»Ñ Ð²Ð°Ñ Ð¸Ð½Ð´Ð¸Ð²Ð¸Ð´ÑƒÐ°Ð»ÑŒÐ½Ð¾Ðµ Ð¿Ñ€ÐµÐ´Ð»Ð¾Ð¶ÐµÐ½Ð¸Ðµ. ÐÐ°ÑˆÐ¸ ÑÑ‚Ð°Ñ€ÑˆÐ¸Ðµ ÑÐºÑÐ¿ÐµÑ€Ñ‚Ñ‹ ÑÐ²ÑÐ¶ÑƒÑ‚ÑÑ Ñ Ð²Ð°Ð¼Ð¸ Ð² Ð¿Ñ€Ð¸Ð¾Ñ€Ð¸Ñ‚ÐµÑ‚Ð½Ð¾Ð¼ Ð¿Ð¾Ñ€ÑÐ´ÐºÐµ.</p>

                    <form action="#" class="cta-crystal__form">
                        <div class="cta-crystal__field">
                            <input type="text" placeholder=" " required id="c-f-name">
                            <label for="c-f-name">Ð’Ð°ÑˆÐµ Ð¸Ð¼Ñ</label>
                        </div>
                        <div class="cta-crystal__field">
                            <input type="text" placeholder=" " required id="c-f-company">
                            <label for="c-f-company">ÐÐ°Ð·Ð²Ð°Ð½Ð¸Ðµ ÐºÐ¾Ð¼Ð¿Ð°Ð½Ð¸Ð¸</label>
                        </div>
                        <div class="cta-crystal__field">
                            <input type="tel" placeholder=" " required id="c-f-phone">
                            <label for="c-f-phone">Ð¢ÐµÐ»ÐµÑ„Ð¾Ð½</label>
                        </div>
                        ...
                        <div class="cta-crystal__field nx-dropdown" id="contactServicesDropdown">
                            ...
                            <label for="c-f-service-input">Ð’Ð°Ñˆ Ð²Ð¾Ð¿Ñ€Ð¾Ñ / Ð£ÑÐ»ÑƒÐ³Ð° <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" style="margin-left: 4px; display: inline-block; vertical-align: middle;"><path d="m6 9 6 6 6-6"/></svg></label>
                            <div class="nx-dropdown__panel">
                                <div class="nx-dropdown__option" data-val="audit">ÐÑƒÐ´Ð¸Ñ‚ Ñ„Ð¸Ð½Ð°Ð½ÑÐ¾Ð²Ð¾Ð¹ Ð´ÐµÑÑ‚ÐµÐ»ÑŒÐ½Ð¾ÑÑ‚Ð¸</div>
                                <div class="nx-dropdown__option" data-val="restore">Ð’Ð¾ÑÑÑ‚Ð°Ð½Ð¾Ð²Ð»ÐµÐ½Ð¸Ðµ ÑƒÑ‡ÐµÑ‚Ð°</div>
                                <div class="nx-dropdown__option" data-val="legal">Ð®Ñ€Ð¸Ð´Ð¸Ñ‡ÐµÑÐºÐ¸Ðµ ÐºÐ¾Ð½ÑÑƒÐ»ÑŒÑ‚Ð°Ñ†Ð¸Ð¸</div>
                                <div class="nx-dropdown__option" data-val="accounting">Ð¤Ð¸Ð½. Ð¸ ÐºÐ°Ð´Ñ€Ð¾Ð²Ñ‹Ð¹ ÑƒÑ‡ÐµÑ‚</div>
                                <div class="nx-dropdown__option" data-val="secretariat">Ð£ÑÐ»ÑƒÐ³Ð¸ ÑÐµÐºÑ€ÐµÑ‚Ð°Ñ€Ð¸Ð°Ñ‚Ð°</div>
                                <div class="nx-dropdown__option" data-val="consulting">Ð‘Ð¸Ð·Ð½ÐµÑ-ÐºÐ¾Ð½ÑÑƒÐ»ÑŒÑ‚Ð°Ñ†Ð¸Ð¸</div>
                                <div class="nx-dropdown__option" data-val="tax">ÐÐ°Ð»Ð¾Ð³Ð¾Ð²Ñ‹Ðµ ÐºÐ¾Ð½ÑÑƒÐ»ÑŒÑ‚Ð°Ñ†Ð¸Ð¸</div>
                                <div class="nx-dropdown__option" data-val="management">Ð£Ð¿Ñ€Ð°Ð²Ð»ÐµÐ½Ñ‡ÐµÑÐºÐ¸Ð¹ ÑƒÑ‡ÐµÑ‚</div>
                                <div class="nx-dropdown__option" data-val="automation">ÐÐ²Ñ‚Ð¾Ð¼Ð°Ñ‚Ð¸Ð·Ð°Ñ†Ð¸Ñ Ð±Ð¸Ð·Ð½ÐµÑÐ°</div>
                                <div class="nx-dropdown__option" data-val="planning">Ð‘Ð¸Ð·Ð½ÐµÑ-Ð¿Ð»Ð°Ð½Ð¸Ñ€Ð¾Ð²Ð°Ð½Ð¸Ðµ</div>
                                <div class="nx-dropdown__option" data-val="other">Ð”Ñ€ÑƒÐ³Ð¾Ð¹ Ð²Ð¾Ð¿Ñ€Ð¾Ñ</div>
                            </div>
                        </div>

                        <button type="submit" class="cta-crystal__btn">
                            <span>ÐžÑ‚Ð¿Ñ€Ð°Ð²Ð¸Ñ‚ÑŒ Ð·Ð°Ð¿Ñ€Ð¾Ñ</span>
                        ...
                        <div style="display: flex; align-items: center; justify-content: center; gap: 8px; margin-top: 10px; color: #10B981; font-size: 12px; font-weight: 500;">
                            ...
                            Ð—Ð°Ñ‰Ð¸Ñ‰Ñ‘Ð½Ð½Ð¾Ðµ ÑÐ¾ÐµÐ´Ð¸Ð½ÐµÐ½Ð¸Ðµ (SSL 256-bit)
                        </div>
                    </form>
                </div>
            </div>
    ...
    <!-- â•â•â•â•â•â•â•â•â•â•â• INTERACTIVE MAP â•â•â•â•â•â•â•â•â•â•â• -->
    <section class="section" style="padding: 0;">
        <div style="height: 500px; width: 100%; position: relative; background: var(--nk-gray-100);">
            ...
            <div style="position: absolute; bottom: 40px; right: 40px; background: white; padding: 20px 30px; border-radius: 12px; box-shadow: 0 20px 40px rgba(0, 13, 51, 0.1); display: flex; align-items: center; gap: 16px;">
                ...
                <div>
                    <h4 style="margin: 0 0 4px; font-size: 16px; color: var(--nk-gray-900);">Ð¦ÐµÐ½Ñ‚Ñ€Ð°Ð»ÑŒÐ½Ñ‹Ð¹ Ð¾Ñ„Ð¸Ñ</h4>
                    <span style="font-size: 14px; color: var(--nk-gray-600);">ÐŸÑ€Ð¾ÑÐ¿ÐµÐºÑ‚ Ð ÑƒÐ´Ð°ÐºÐ¸ 55</span>
                </div>
            </div>
        </div>
    </section>
