                ...
                <div className="hidden lg:flex items-center gap-2">
                    {navLinks.map((link) => (
                        <a
                            key={link.name}
                            href={link.href}
                            className="px-5 py-2 text-[12px] font-light uppercase tracking-[0.3em] text-foreground/40 hover:text-accent transition-all duration-500"
                        >
                            {link.name}
                        </a>
                    ))}
                    ...
                    <div className="flex items-center gap-6 ml-8 px-6 py-2 bg-accent/[0.03] relative group/lang">
                        ...
                        {['EN', 'RU', 'TJ'].map((lang) => (
                            <Link
                                ...
                                className={`text-[10px] font-light uppercase tracking-[0.4em] transition-all duration-700 ${locale === lang.toLowerCase() ? 'text-accent' : 'text-foreground/20 hover:text-accent'
                                    }`}
                            >
                                {lang}
                            </Link>
                        ...
                        <div className="flex flex-col items-center gap-10">
                            {navLinks.map((link, i) => (
                                <motion.a
                                    ...
                                    className="text-3xl font-display font-light text-foreground/40 hover:text-accent tracking-widest"
                                >
                                    {link.name}
                                </motion.a>
                            ))}
