...
import { ChevronDown, Globe, Layout, Server, ShoppingCart, Layers, Settings, X, Clock, Zap, Shield, Sparkles, Lock } from 'lucide-react';
...
export const ProjectCalculator = () => {
    ...
    const types: { id: ProjectType; label: string; icon: any; badge?: string }[] = [
        ...
        { id: 'Sovereign', label: 'Sovereign Chain', icon: Lock, badge: 'WEB3' },
    ];
    ...
    return (
        <section id="calculator" className="py-[125px] bg-background relative overflow-hidden">
                ...
                <div className="max-w-4xl mx-auto text-center mb-24 flex flex-col items-center">
                    ...
                    >
                        ...
                        <motion.div
                            ...
                            className="mt-16 py-6 px-10 bg-accent/[0.03] backdrop-blur-sm relative overflow-hidden group/promo max-w-2xl mx-auto"
                        >
                            {/* Animated Background Shimmer */}
                            <div className="absolute inset-0 w-full h-full bg-gradient-to-r from-transparent via-accent/[0.05] to-transparent -translate-x-full group-hover:translate-x-full transition-transform duration-2000 ease-in-out" />

                            <div className="relative z-10 space-y-2">
                                <span className="text-[9px] uppercase tracking-[0.5em] text-accent font-bold block animate-pulse">FOUNDATIONAL PARTNER PROTOCOL_</span>
                                <p className="text-[12px] md:text-[14px] uppercase tracking-[0.2em] text-[#E5D5B0] font-light leading-relaxed italic">
                                    THE FIRST 10 RESIDENTS IN THE NEW ARCHIVE RECEIVE <span className="font-bold text-accent">30% CALIBRATION DISCOUNT</span> ON ALL PRODUCTION CYCLES.
                                </p>
                            </div>
                        </motion.div>
                    </motion.div>
                ...
                <div className="max-w-4xl mx-auto bg-white/[0.01] p-10 md:p-20 space-y-32 relative group/calc">
                    ...
                    <div className="space-y-12 relative z-50">
                        <div className="flex flex-col gap-4">
                            <span className="text-[10px] uppercase tracking-[0.4em] text-accent/80 font-bold italic mb-2 block animate-pulse">System 01__</span>
                    ...
                    <div className="space-y-12">
                        <div className="flex flex-col gap-4">
                            <span className="text-[10px] uppercase tracking-[0.4em] text-accent/80 font-bold italic mb-2 block animate-pulse">System 02__</span>
                    ...
                    <div className="space-y-12">
                        <div className="flex flex-col gap-4">
                            <span className="text-[10px] uppercase tracking-[0.4em] text-accent/80 font-bold italic mb-2 block animate-pulse">System 03__</span>
                    ...
                    <div className="space-y-20">
                        <div className="flex flex-col gap-4">
                            <span className="text-[10px] uppercase tracking-[0.4em] text-accent/80 font-bold italic mb-2 block animate-pulse">System 04__</span>
                            ...
                            {[
                                {
                                    ...
                                    cost: '0',
                                    limit: 'ON-DEMAND',
                                    features: ['On-Demand Access Protocol', 'Basic Vulnerability Scan', 'Manual Backup Protocol']
                                },
                                {
                                    level: 'Standard' as SupportLevel,
                                    cost: billingCycle === 'Yearly' ? '700' : '1000',
                                    limit: '08H / MONTHLY',
                                    features: ['8h Maintenance Sprint', 'Automated Weekly Backups', 'Base Cyber-Defense Layer', 'Uptime Monitoring 24/7']
                                },
                                {
                                    level: 'Elite' as SupportLevel,
                                    cost: billingCycle === 'Yearly' ? '2100' : '3000',
                                    limit: '24H / MONTHLY',
                                    features: ['24h Dedicated Support', 'Real-time Daily Backups', 'Advanced Neural Cyber-Defense', 'Architectural Advisory']
                                }
                            ].map((item) => {
                                            ...
                                            <div className="space-y-6">
                                                <div className="flex flex-col">
                                                    <div className="flex items-start gap-1">
                                                        <span className={`text-[12px] transition-colors duration-700 mt-2 font-display ${isActive ? 'text-accent' : 'text-accent/20'}`}>TJS</span>
                                                        <span className={`text-4xl md:text-5xl font-display tracking-tighter leading-none transition-colors duration-1000 ${isActive ? 'text-accent' : 'text-foreground/40'}`}>{item.cost}</span>
                    ...
                    <div className="space-y-12">
                        <div className="flex flex-col gap-4">
                            <span className="text-[10px] uppercase tracking-[0.4em] text-accent/80 font-bold italic mb-2 block animate-pulse">System 05__</span>
                            <h3 className="text-xl md:text-2xl font-display font-light text-[#E5D5B0] tracking-[0.3em] uppercase leading-none">EXPANSION MODULES</h3>
                            <p className="text-[11px] text-foreground/40 leading-relaxed max-w-2xl italic tracking-wide">
                                Enhance your digital asset with specialized infrastructure and strategic identity protocols.
                            </p>
                        </div>

                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                { id: 'branding' as const, label: 'Visual Identity', desc: 'Logo + Brand Guidelines', cost: '3,000 TJS' },
                                { id: 'infrastructure' as const, label: 'Digital Real Estate', desc: 'Domain + 1Y Hosting', cost: '1,000 TJS' },
                                { id: 'seo' as const, label: 'Search Architecture', desc: 'SEO Keyword Strategy', cost: '2,000 TJS' },
                                { id: 'ai' as const, label: 'Neural Protocol', desc: 'LLM / AI Integration', cost: '3,750 TJS' },
                                { id: 'ads' as const, label: 'Market Penetration', desc: 'Ads Google/Yandex', cost: '3,000 TJS' },
                                { id: 'smm' as const, label: 'Social Audit', desc: 'SMM Strategy', cost: '2,500 TJS' },
                                { id: 'adsense' as const, label: 'Monetization Engine', desc: 'AdSense Setup', cost: '1,500 TJS' },
                                { id: 'maps' as const, label: 'Interactive Geolocation', desc: 'Google Maps API', cost: '1,000 TJS' },
                                { id: 'narrative' as const, label: 'Narrative Architecture', desc: 'Copywriting & Storytelling', cost: '2,500–4,000' },
                                { id: 'kinetic' as const, label: 'Kinetic Elegance', desc: 'Premium Scroll Animations', cost: '2,500 TJS' },
                                { id: 'linguistic' as const, label: 'Linguistic Expansion', desc: '3-Language Localization', cost: '+27% of dev' },
                                { id: 'velocity' as const, label: 'Performance Velocity', desc: 'Lighthouse 90+ Tuning', cost: '1,500–2,000' },
                            ].map((addon) => (
                                <button
                                    key={addon.id}
                                    onClick={() => toggleAddon(addon.id)}
                                    className={`group relative p-6 text-left transition-all duration-700 flex flex-col gap-3 overflow-hidden ${addons[addon.id] ? 'bg-accent/[0.08]' : 'bg-background/20 hover:bg-white/[0.02]'}`}
                                >
                                    {addons[addon.id] && (
                                        <>
                                            <div className="absolute top-0 right-0 w-16 h-16 bg-accent/[0.05] blur-2xl -translate-y-1/2 translate-x-1/2" />
                                            {/* Precision Corners for Active Addon */}
                                            <div className="absolute top-0 left-0 w-3 h-3 border-t-[0.5px] border-l-[0.5px] border-accent" />
                                            <div className="absolute top-0 right-0 w-3 h-3 border-t-[0.5px] border-r-[0.5px] border-accent" />
                                            <div className="absolute bottom-0 left-0 w-3 h-3 border-b-[0.5px] border-l-[0.5px] border-accent" />
                                            <div className="absolute bottom-0 right-0 w-3 h-3 border-b-[0.5px] border-r-[0.5px] border-accent" />
                                        </>
                                    )}

                                    <div className="flex justify-between items-start gap-4 z-10 w-full">
                                        <div className="space-y-1">
                                            <span className={`text-[10px] uppercase tracking-[0.2em] font-black transition-colors ${addons[addon.id] ? 'text-accent' : 'text-foreground/60'}`}>{addon.label}</span>
                                            <p className="text-[9px] text-foreground/30 font-light italic leading-relaxed">{addon.desc}</p>
                                        </div>
                                        <span className={`text-[9px] font-bold tracking-widest text-right shrink-0 ${addons[addon.id] ? 'text-accent' : 'text-accent/40'}`}>{addon.cost}</span>
                                    </div>
                    ...
                    <div className="pt-24 border-t-[0.5px] border-accent/10 flex flex-col items-center gap-20 relative">
                        <div className="text-center space-y-8">
                            <div>
                                <span className="text-[10px] uppercase tracking-[1em] text-accent/60 font-bold block mb-10">EST. ASSET VALUE_</span>
                                <AnimatePresence mode="wait">
                                    <motion.div
                                        ...
                                        className="text-7xl md:text-9xl font-display font-extralight text-[#E5D5B0] tracking-tighter flex items-baseline justify-center gap-4"
                                    >
                                        {totalPrice.toLocaleString()} <span className="text-4xl md:text-6xl font-display uppercase tracking-widest text-[#E5D5B0]/30">TJS</span>
                                    </motion.div>
                                </AnimatePresence>
                            </div>
                            ...
                            >
                                <span className="text-[10px] uppercase tracking-[0.4em] text-accent font-black animate-pulse">FOUNDATIONAL_ACCESS_RATE:</span>
                                <span className="text-3xl md:text-5xl font-display text-accent font-light tracking-widest">
                                    {Math.round(totalPrice * 0.7).toLocaleString()} TJS
                                </span>
                                <p className="text-[10px] uppercase tracking-[0.2em] text-foreground/40 italic mt-2.5">
                                    -30% applied for the first 10 residents of the new archive
                                </p>
                            </motion.div>
                        </div>
            ...
            <div className="absolute bottom-12 left-1/2 -translate-x-1/2 opacity-60 pointer-events-none w-full text-center">
                <span className="text-[10px] uppercase tracking-[1.25em] text-accent/80 font-bold -mr-[1.25em]">PROPRIETARY ALGORITHMIC INVESTMENT ANALYSIS v8.8_ACTIVE</span>
            </div>
        </section>
    );
};