...
<div className="w-10 h-10 relative flex items-center justify-center text-foreground/75 group-hover:text-accent group-hover:bg-accent/[0.03] transition-all duration-1000">
