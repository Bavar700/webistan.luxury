    ...
    return (
        <section id="services" className="py-[125px] bg-background relative overflow-hidden">
                        ...
                        >
                            ...
                            <div className="relative z-10 text-center flex flex-col items-center">
                                <div className="space-y-4 w-full">
                                    <span className="text-[10px] font-display uppercase tracking-[0.6em] text-accent/80 block italic -mr-[0.6em] font-bold animate-pulse">Layer 0{i + 1}</span>
            ...
            <div className="absolute bottom-12 left-1/2 -translate-x-1/2 opacity-60 pointer-events-none w-full text-center">
                <span className="text-[10px] uppercase tracking-[1.25em] text-accent/80 font-bold -mr-[1.25em]">STRATEGIC ARCHITECTURE LAYER_v4.2</span>
            </div>
        </section>
    );
};
