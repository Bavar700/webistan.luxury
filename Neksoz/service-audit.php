<?php
/**
 * Template Name: service-audit
 */
if (function_exists('nk_get_current_lang')) {
    $lang = nk_get_current_lang();
    if ($lang === 'tj') { get_template_part('service-audit', 'tj'); return; }
    if ($lang === 'en') { get_template_part('service-audit', 'en'); return; }
}
get_header();
?>
        ...
        <div class="container">
            ...
            <div class="services-grid" style="grid-template-columns: repeat(2, 1fr); gap: 40px;">
                ...
                <div class="service-card" style="height: 100%;">
                    ...
                    <h3 class="service-card__title">Когда нужен <br>аудит?</h3></div>
                    <div class="service-card__tasks">
                        <ul class="service-card__list">
                            <li>Подтверждение отчетности для инвесторов</li>
                            <li>Сомнения в текущей финансовой службе</li>
                ...
                <div class="service-card" style="height: 100%;">
                    ...
                    <div class="service-card__tasks">
                        <ul class="service-card__list">
                            ...
                            <li>Проверка законности учетных записей</li>
                            <li>Анализ перспектив будущих событий</li>
                ...
                <div class="service-card" style="height: 100%;">
                    ...
                    <div class="service-card__tasks">
                        <ul class="service-card__list">
                            <li>Предварительный анализ операций</li>
                            <li>Разработка детальной программы</li>
    ...
    <section id="lead-form" class="section section--gray" style="border-top: 1px solid var(--nk-gray-100); padding-top: 40px; padding-bottom: 80px;">
        <div class="container" style="max-width: 800px;">
            <div class="section__header section__header--center" style="margin-bottom: 60px;">
                ...
                <p class="section__subtitle" style="margin-bottom: 0;">Оставьте заявку на предварительный аудиторский анализ.<br>Мы свяжемся с вами в течение 30 минут.</p>
            </div>
            ...
            <div class="cta-crystal__form-box" style="background: var(--nk-white); padding: 60px; border-radius: 32px; box-shadow: 0 40px 100px rgba(0, 13, 51, 0.08); border: 1px solid var(--nk-gray-50);">
                <form class="cta-crystal__form" action="#" method="POST" style="display: grid; gap: 24px;">
                    ...
                    <button type="submit" class="cta-crystal__btn"><span>Запросить аудит</span><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M5 12h14"/><path d="m12 5 7 7-7 7"/></svg></button>
