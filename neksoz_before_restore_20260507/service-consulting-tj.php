<?php
/**
 * Template Name: Service: Consulting (TJ)
 */
get_header();
?>
...
<main class="site-main">
        ...
        <div class="container hero__container" style="position:relative;z-index:2;">
            <div class="hero__content">
                ...
                <h1 class="hero__title">
                    <span style="white-space: nowrap;">Машварати молиявию</span><br>
                    <span class="text-gradient" style="white-space: nowrap;">идоракунии тиҷорат</span>
                </h1>
                <p class="hero__desc">
    ...
    <section class="section">
        <div class="container">
            <div class="section__header section__header--center" style="margin-bottom: 60px;">
                <div class="section__label">Рушди роҳбурдӣ</div>
                <h2 class="section__title">Коршиносӣ барои рушди Шумо</h2>
                <p class="section__subtitle">Мо ба моликон кумак мерасонем, ки аз корҳои рӯзмарра (амалиётӣ)<br>раҳо ёфта, молияи ширкатро ба мувозинат дароранд.</p>
            </div>
            ...
            <div class="services-grid" style="grid-template-columns: repeat(2, 1fr); gap: 40px;">
                ...
                <div class="service-card" style="height: 100%;">
                    ...
                    <h3 class="service-card__title">Машварат кай <br>зарур аст?</h3></div>
                    <div class="service-card__tasks">
                        <ul class="service-card__list">
                            <li>Рушди тиҷорат қатъ шудааст ё фоида кам мешавад</li>
                            <li>Касри хазинавӣ ва норасоии маблағҳои гардон</li>
                            <li>Беназмӣ дар равандҳо ва баҳисобгирии идоракунӣ</li>
                            <li>Молик аз ҳад зиёд ба корҳои якнавохт банд аст</li>
                            <li>Арзёбии мустақили самаранокӣ лозим аст</li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="service-card" style="height: 100%;">
                    ...
                    <div class="service-card__tasks">
                        <ul class="service-card__list">
                            <li>Аудити низоми идоракунӣ ва молия</li>
                            <li>Ҷорӣ намудани баҳисобгирии идоракунӣ (KPI)</li>
                            <li>Бунёди модели молиявии тиҷорат</li>
                            <li>Беҳсозии хароҷот ва андозҳо</li>
                            <li>Таҳияи роҳбурд барои 1-3 сол</li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="service-card" style="height: 100%;">
                    ...
                    <div class="service-card__tasks">
                        <ul class="service-card__list">
                            <li>Мусоҳибаи амиқ ва таҳлили маълумот</li>
                            <li>Ҷустуҷӯи "нуқтаҳои заиф" дар кори ширкат</li>
                            <li>Таҳияи нақшаи беҳсозӣ (Roadmap)</li>
                            <li>Марҳила ба марҳила ҷорӣ намудани тағйирот</li>
                            <li>Назорати натиҷаҳо ва ислоҳсозӣ</li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="service-card" style="height: 100%;">
                    ...
                    <div class="service-card__tasks">
                        <ul class="service-card__list">
                            <li>Афзоиши фоидаи соф ва даромаднокӣ</li>
                            <li>Манзараи шаффофи молиявӣ (P&L, CashFlow)</li>
                            <li>Муносибати муназзам ба идоракунии гурӯҳ</li>
                            <li>Раҳоии молик аз раванди амалиётӣ</li>
                            <li>Устувории тиҷорат ба буҳронҳо</li>
                        </ul>
                    </div>
                </div>
    ...
    <section id="lead-form" class="section section--gray" style="border-top: 1px solid var(--nk-gray-100); padding-top: 40px; padding-bottom: 80px;">
        <div class="container" style="max-width: 800px;">
            <div class="section__header section__header--center" style="margin-bottom: 60px;">
                <div class="section__label">Таҳлили коршинос</div>
                <h2 class="section__title">Машварати фаврии ройгон</h2>
                <p class="section__subtitle" style="margin-bottom: 0;">Барои таҳлили пешакии тиҷорати худ дархост гузоред.<br>Мо дар давоми 30 дақиқа бо Шумо дар тамос хоҳем шуд.</p>
            </div>
                ...
                <form class="cta-crystal__form" action="#" method="POST" style="display: grid; gap: 24px;">
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 24px;">
                        <div class="cta-crystal__field">
                            ...
                            <label for="cn-name">Номи Шумо</label>
                        </div>
                        <div class="cta-crystal__field">
                    ...
                    <div class="cta-crystal__field">
                        ...
                        <label for="cn-company">Номи ширкат (ихтиёрӣ)</label>
                    </div>
                    <button type="submit" class="cta-crystal__btn"><span>Фармоиши ҳисоб</span><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M5 12h14"/><path d="m12 5 7 7-7 7"/></svg></button>
