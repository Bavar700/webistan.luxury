<?php
/**
 * Template Name: service-tax
 */
if (function_exists('nk_get_current_lang')) {
    $lang = nk_get_current_lang();
    if ($lang === 'tj') { get_template_part('service-tax', 'tj'); return; }
    if ($lang === 'en') { get_template_part('service-tax', 'en'); return; }
}
    ...
    <section class="hero hero--internal">
        ...
        <div class="container hero__container" style="position:relative;z-index:2;">
            <div class="hero__content">
                <div class="hero__badge">Департамент налогов</div>
                <h1 class="hero__title">
                    <span style="white-space: nowrap;">Экспертные налоговые</span><br>
                    <span class="text-gradient" style="white-space: nowrap;">консультации для бизнеса</span>
                </h1>
                <p class="hero__desc">
        ...
        <div class="container">
            ...
            <div class="services-grid" style="grid-template-columns: repeat(2, 1fr); gap: 40px;">
                ...
                <div class="service-card" style="height: 100%;">
                    ...
                    <h3 class="service-card__title">Что входит в услугу?</h3></div>
                    <div class="service-card__tasks">
                        <ul class="service-card__list">
                            <li>Налоговые консультации (для ЮЛ и ФЛ)</li>
                            ...
                            <li>Оптимизация налоговых платежей в рамках закона</li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="service-card" style="height: 100%;">
                    ...
                    <h3 class="service-card__title">Как мы работаем?</h3></div>
                    <div class="service-card__tasks">
                        <ul class="service-card__list">
                            <li>Глубокий анализ текущей налоговой модели</li>
                            <li>Поиск законных путей снижения нагрузки</li>
                            <li>Устранение ошибок, привлекающих внимание</li>
                            <li>Защита интересов клиента в органах</li>
                            <li>Полное сопровождение при проверках</li>
                        </ul>
                    </div>
                </div>
