<?php
/**
 * Template Name: Service: Business Plan (EN)
 */
get_header();
?>
...
<main class="site-main">
        ...
        <div class="container hero__container" style="position:relative;z-index:2;">
            <div class="hero__content">
                ...
                <h1 class="hero__title">
                    ...
                    <span class="text-gradient">feasibility study development</span>
                </h1>
                <p class="hero__desc">
            ...
            <div class="hero__actions--right">
                <a href="#lead-form" class="btn btn--primary" style="padding: 16px 36px; font-size: 11px;">
                    <span>Order a Business Plan</span>
    ...
    <section class="section">
        <div class="container">
            <div class="section__header section__header--center" style="margin-bottom: 60px;">
                <div class="section__label">Strategic Foundation</div>
                <h2 class="section__title">Your success begins<br>with an accurate calculation</h2>
                <p class="section__subtitle">We turn your ideas into numbers and facts<br>trusted by investors and banks.</p>
            </div>
            ...
            <div class="services-grid" style="grid-template-columns: repeat(2, 1fr); gap: 40px;">
                ...
                <div class="service-card" style="height: 100%;">
                    ...
                    <h3 class="service-card__title">When is a business <br>plan needed?</h3></div>
                    <div class="service-card__tasks">
                        <ul class="service-card__list">
                            <li>Launching a new investment project</li>
                            <li>Attracting external financing or grants</li>
                            <li>Finding strategic partners</li>
                            <li>Justifying efficiency for management</li>
                            <li>Entering new sales markets</li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="service-card" style="height: 100%;">
                    ...
                    <h3 class="service-card__title">What does the <br>development include?</h3></div>
                    <div class="service-card__tasks">
                        <ul class="service-card__list">
                            <li>In-depth market and competitor analysis</li>
                            <li>Financial model (Cash Flow, P&L, ROI)</li>
                            <li>Preparation of FS matching RT requirements</li>
                            <li>Calculation of tax burden and payback period</li>
                ...
                <div class="service-card" style="height: 100%;">
                    ...
                    <h3 class="service-card__title">Stages of <br>our work</h3></div>
                    <div class="service-card__tasks">
                        <ul class="service-card__list">
                            <li>Collection of primary data and interview</li>
                            <li>Designing a detailed financial model</li>
                            <li>Writing the text section and SWOT analysis</li>
                            <li>Visualization of indicators (Pitch Deck)</li>
                            <li>Support during negotiations with investors</li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="service-card" style="height: 100%;">
                    ...
                    <h3 class="service-card__title">Results for <br>your project</h3></div>
                    <div class="service-card__tasks">
                        <ul class="service-card__list">
                            <li>A document ready for submission to a bank or fund</li>
                            <li>Objective picture of the break-even point</li>
                            <li>Justification for receiving benefits and grants</li>
                            <li>Increased chances of attracting investments</li>
                            <li>Roadmap for project implementation</li>
                        </ul>
                    </div>
                </div>
    ...
    <section id="lead-form" class="section section--gray" style="border-top: 1px solid var(--nk-gray-100); padding-top: 40px; padding-bottom: 80px;">
        <div class="container" style="max-width: 800px;">
            <div class="section__header section__header--center" style="margin-bottom: 60px;">
                <div class="section__label">Investment Consulting</div>
                <h2 class="section__title">Free idea assessment</h2>
                <p class="section__subtitle" style="margin-bottom: 0;">Leave a request for a preliminary review of your project.<br>We will contact you within 30 minutes.</p>
            </div>
                ...
                <form class="cta-crystal__form" action="#" method="POST" style="display: grid; gap: 24px;">
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 24px;">
                        <div class="cta-crystal__field">
                            ...
                            <label for="bp-name">Your Name</label>
                        </div>
                        <div class="cta-crystal__field">
                            <input type="tel" placeholder=" " required id="bp-phone">
                            <label for="bp-phone">Phone (+992)</label>
                        </div>
                    </div>
                    <div class="cta-crystal__field">
                        <input type="text" placeholder=" " id="bp-company">
                        <label for="bp-company">Project / Company Name</label>
                    </div>
                    <button type="submit" class="cta-crystal__btn"><span>Request for consultation</span><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M5 12h14"/><path d="m12 5 7 7-7 7"/></svg></button>
