		...
		<div class="flex flex-col items-center justify-center space-y-6">
			...
			<div class="text-center order-2">
				<p class="text-sm text-gray-400">
					<?php echo tr('footer_project_name'); ?> - <?php echo date('Y'); ?>. <?php echo tr('footer_tagline'); ?>
				</p>
				<p class="text-xs text-gray-500 mt-2">
					<?php echo tr('footer_developed_by'); ?> <span class="text-gray-400 hover:text-primary transition-colors cursor-default">Webistan Luxury</span>
				</p>
			</div>
		</div>
	</div>
