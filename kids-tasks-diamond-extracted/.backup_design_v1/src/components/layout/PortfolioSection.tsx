    ...
    return (
        <section id="portfolio" className="py-[125px] bg-background relative overflow-hidden">
                        ...
                        >
                            ...
                            <div className="relative z-10 text-center flex flex-col items-center">
                                <div className="space-y-4 w-full">
                                    <span className="text-[10px] font-display uppercase tracking-[0.6em] text-accent/40 block italic -mr-[0.6em]">Protocol 0{i + 1}</span>
            ...
            <div className="absolute bottom-12 left-1/2 -translate-x-1/2 opacity-20 pointer-events-none w-full text-center">
                <span className="text-[9px] uppercase tracking-[1em] text-accent/60 font-light -mr-[1em]">Genesis Production Protocol</span>
            </div>
        </section>
    );
};
