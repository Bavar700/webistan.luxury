...
<main class="flex-grow bg-white">
	<?php if ( have_posts() ) : ?>
		<!-- Hero Section -->
		<div class="relative isolate h-screen w-full flex items-center justify-center bg-cover bg-no-repeat overflow-hidden" style="background-image: url('<?php echo yaghnob_get_image_url('hero-bg.jpg', 'Yaghnob'); ?>'); background-size: cover; background-position: center top;">
