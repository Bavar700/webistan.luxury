			...
			<div class="grid grid-cols-1 lg:grid-cols-4 gap-8">
				...
				<div class="hidden lg:block lg:col-span-1 space-y-8">
					<div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100 sticky top-32">
						<h3 class="text-sm font-bold uppercase tracking-wider text-gray-900 mb-4 border-b border-gray-100 pb-2"><?php echo tr('library_categories_title'); ?></h3>
						...
						<nav class="space-y-1">
							<a href="#" class="flex items-center justify-between px-3 py-2 text-sm font-medium text-primary bg-primary/5 rounded-md group transition-colors">
								<span><?php echo tr('library_cat_all'); ?></span>
							...
							<a href="#" class="flex items-center justify-between px-3 py-2 text-sm font-medium text-gray-600 hover:bg-gray-50 hover:text-primary rounded-md group transition-colors">
								<span><?php echo tr('library_cat_books'); ?></span>
							...
							<a href="#" class="flex items-center justify-between px-3 py-2 text-sm font-medium text-gray-600 hover:bg-gray-50 hover:text-primary rounded-md group transition-colors">
								<span><?php echo tr('library_cat_papers'); ?></span>
							...
							<a href="#" class="flex items-center justify-between px-3 py-2 text-sm font-medium text-gray-600 hover:bg-gray-50 hover:text-primary rounded-md group transition-colors">
								<span><?php echo tr('library_cat_maps'); ?></span>
							...
							<a href="#" class="flex items-center justify-between px-3 py-2 text-sm font-medium text-gray-600 hover:bg-gray-50 hover:text-primary rounded-md group transition-colors">
								<span><?php echo tr('library_cat_reports'); ?></span>
							...
							<a href="#" class="flex items-center justify-between px-3 py-2 text-sm font-medium text-gray-600 hover:bg-gray-50 hover:text-primary rounded-md group transition-colors">
								<span><?php echo tr('library_cat_audio'); ?></span>
						...
						<div class="mt-8">
							<h3 class="text-sm font-bold uppercase tracking-wider text-gray-900 mb-4 border-b border-gray-100 pb-2"><?php echo tr('library_lang_title'); ?></h3>
							<div class="space-y-2">
								<label class="flex items-center gap-2 text-sm text-gray-600 cursor-pointer hover:text-primary transition-colors">
									...
									<span><?php echo tr('library_lang_en'); ?></span>
								</label>
								<label class="flex items-center gap-2 text-sm text-gray-600 cursor-pointer hover:text-primary transition-colors">
									<input type="checkbox" class="rounded border-gray-300 text-primary focus:ring-primary/50">
									<span><?php echo tr('library_lang_ru'); ?></span>
								</label>
								<label class="flex items-center gap-2 text-sm text-gray-600 cursor-pointer hover:text-primary transition-colors">
									<input type="checkbox" class="rounded border-gray-300 text-primary focus:ring-primary/50">
									<span><?php echo tr('library_lang_tg'); ?></span>
								</label>
								<label class="flex items-center gap-2 text-sm text-gray-600 cursor-pointer hover:text-primary transition-colors">
									<input type="checkbox" class="rounded border-gray-300 text-primary focus:ring-primary/50">
									<span><?php echo tr('library_lang_de'); ?></span>
								</label>
							</div>
						</div>
				...
				<div class="lg:col-span-3">
					...
					<div class="flex flex-col sm:flex-row items-center justify-between gap-4 mb-8">
						<div class="relative w-full sm:max-w-xs">
							...
							<input type="search" class="block w-full pl-10 pr-3 py-2 bg-white border border-gray-200 rounded-lg text-sm placeholder-gray-400 focus:outline-none focus:ring-1 focus:ring-primary/50 focus:border-primary/50 shadow-sm" placeholder="<?php echo tr('library_search_placeholder'); ?>">
						</div>
						
						<div class="flex items-center gap-2 w-full sm:w-auto">
							<span class="text-xs font-medium text-gray-500 whitespace-nowrap"><?php echo tr('library_sort_by'); ?></span>
							<select class="block w-full pl-3 pr-8 py-2 text-sm bg-white border border-gray-200 rounded-lg focus:outline-none focus:ring-1 focus:ring-primary/50 focus:border-primary/50 shadow-sm">
								<option><?php echo tr('library_sort_newest'); ?></option>
								<option><?php echo tr('library_sort_oldest'); ?></option>
								<option><?php echo tr('library_sort_title'); ?></option>
								<option><?php echo tr('library_sort_popularity'); ?></option>
							</select>
						</div>
					</div>
							...
							<article class="bg-white rounded-xl overflow-hidden shadow-sm border border-gray-100 hover:shadow-md transition-all duration-300 group flex flex-col" data-aos="fade-up">
								...
								<div class="p-6 flex flex-col flex-grow">
									<div class="flex items-center gap-2 text-xs text-gray-500 mb-2">
										...
										<span>&bull;</span>
										<span><?php echo tr( $resource['lang'] ); ?></span>
									</div>
									...
									<p class="text-sm text-gray-600 mb-4 flex-grow">
										<?php echo tr('res_by_author'); ?> <?php echo esc_html( $resource['author'] ); ?>
									</p>
