<?php
/**
 * Template Name: Service: Management (TJ)
 */
get_header();
?>
...
<main class="site-main">
        ...
        <div class="container hero__container" style="position:relative;z-index:2;">
            <div class="hero__content">
                ...
                <h1 class="hero__title">
                    <span style="white-space: nowrap;">Баҳисобгирии шаффофи</span><br>
            ...
            <div class="hero__actions--right">
                <a href="#lead-form" class="btn btn--primary" style="padding: 16px 36px; font-size: 11px;">
                    <span>Ҷорӣ намудани баҳисобгирӣ</span>
    ...
    <section class="section">
        <div class="container">
            <div class="section__header section__header--center" style="margin-bottom: 60px;">
                ...
                <p class="section__subtitle">Мо гузоришҳои хушкро ба абзори пурқудрати идоракунии захираҳо ва фоида табдил медиҳем.</p>
            </div>
            ...
            <div class="services-grid" style="grid-template-columns: repeat(2, 1fr); gap: 40px;">
                ...
                <div class="service-card" style="height: 100%;">
                    ...
                    <h3 class="service-card__title">Мониторинг кай <br>зарур аст?</h3></div>
                    <div class="service-card__tasks">
                        <ul class="service-card__list">
                            <li>Гузоришҳои муҳосибӣ манзараи пурраро нишон намедиҳанд</li>
                            <li>Касрҳои зуд-зуди хазинавӣ (ҳангоми фоида пул нест)</li>
                            <li>Нофаҳмост, ки кадом лоиҳаҳо дар асл зарароваранд</li>
                            <li>Назорати хароҷот дар вақти воқеӣ лозим аст</li>
                            <li>Дурнамои асосноки рушд талаб карда мешавад</li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="service-card" style="height: 100%;">
                    ...
                    <div class="service-card__tasks">
                        <ul class="service-card__list">
                            ...
                            <li>Танзими гузоришҳо ба хусусияти тиҷорат</li>
                            <li>Ҳисобкунии даромаднокии самтҳо ва хизматрасониҳо</li>
                            <li>Банақшагирии хазинавӣ ва тақвими пардохтҳо</li>
                ...
                <div class="service-card" style="height: 100%;">
                    ...
                    <div class="service-card__tasks">
                        <ul class="service-card__list">
                            ...
                            <li>Лоиҳакашии низоми мақсадноки гузоришҳо</li>
                            <li>Худкоркунии ҷамъоварии маълумот (1С, Excel, CRM)</li>
                            <li>Омӯзиши роҳбарон барои хондани гузоришҳо</li>
                            <li>Мушоияти мунтазам ва навсозӣ</li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="service-card" style="height: 100%;">
                    ...
                    <div class="service-card__tasks">
                        <ul class="service-card__list">
                            <li>Манзараи ҳармоҳаи "солимӣ" дар рақамҳо</li>
                            <li>Абзори дурнамосозии дақиқи фоида</li>
                            <li>Идоракунӣ дар асоси далелҳо, на эҳсосот</li>
                            <li>Барҳам додани касрҳои хазинавӣ барои ҳамеша</li>
    ...
    <section id="lead-form" class="section section--gray" style="border-top: 1px solid var(--nk-gray-100); padding-top: 40px; padding-bottom: 80px;">
        <div class="container" style="max-width: 800px;">
            <div class="section__header section__header--center" style="margin-bottom: 60px;">
                <div class="section__label">Аудити молиявӣ</div>
                <h2 class="section__title">Ташхиси фаврии ройгон</h2>
                <p class="section__subtitle" style="margin-bottom: 0;">Барои таҳлили пешакии низоми баҳисобгирии худ дархост гузоред.<br>Мо дар давоми 30 дақиқа бо Шумо дар тамос хоҳем шуд.</p>
            </div>
