...
abstract class Base_Post_Field extends \Voxel\Utils\Object_Fields\Base_Field {
	...
	public function passes_visibility_rules( ?array $context = null ): bool {
		...
		$rules_passed = \Voxel\evaluate_visibility_rules( $rules, $context );
	...
	public function get_model_value( $model_key ) {
		if ( ! array_key_exists( $model_key, $this->props ) ) {
			return null;
		}
