    ...
    return (
        <section id="calculator" className="py-[125px] bg-background relative overflow-hidden">
            <div className="container mx-auto px-6 max-w-7xl relative z-10">
                {/* Elite Promo Banner */}
                <div className="max-w-5xl mx-auto mb-24 text-center px-4">
                    <motion.div
                    ...
                    >
                        {/* Ambient Glow */}
                        <div className="absolute inset-0 bg-accent/5 blur-3xl rounded-[2rem] opacity-50 group-hover:opacity-100 group-hover:bg-accent/10 transition-all duration-1500" />

                        {/* Frame */}
                        <div className="bg-background/80 backdrop-blur-xl border-[0.5px] border-accent/20 p-8 md:p-14 relative overflow-hidden transition-all duration-1500 hover:border-accent/40 hover:shadow-[0_0_50px_-15px_rgba(192,160,128,0.2)]">
                            {/* Animated Scanner Edge */}
                            <div className="absolute top-0 left-0 w-full h-[1px] bg-gradient-to-r from-transparent via-accent/80 to-transparent -translate-x-full group-hover:animate-shimmer" />
                            <div className="absolute bottom-0 right-0 w-full h-[1px] bg-gradient-to-l from-transparent via-accent/80 to-transparent translate-x-full group-hover:animate-shimmer" />

                            {/* Inner Radial Background */}
                            <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_0%,_rgba(192,160,128,0.05),_transparent_70%)] opacity-0 group-hover:opacity-100 transition-opacity duration-1500" />

                            {/* Precision Corners */}
                            <div className="absolute top-0 left-0 w-6 h-6 border-t-[0.5px] border-l-[0.5px] border-accent/60 transition-all duration-1000 group-hover:w-8 group-hover:h-8" />
                            <div className="absolute top-0 right-0 w-6 h-6 border-t-[0.5px] border-r-[0.5px] border-accent/60 transition-all duration-1000 group-hover:w-8 group-hover:h-8" />
                            <div className="absolute bottom-0 left-0 w-6 h-6 border-b-[0.5px] border-l-[0.5px] border-accent/60 transition-all duration-1000 group-hover:w-8 group-hover:h-8" />
                            <div className="absolute bottom-0 right-0 w-6 h-6 border-b-[0.5px] border-r-[0.5px] border-accent/60 transition-all duration-1000 group-hover:w-8 group-hover:h-8" />
                ...
                <div className="max-w-4xl mx-auto bg-white/[0.01] p-10 md:p-20 space-y-32 relative group/calc">
                    ...
                    <div className="space-y-12">
                        <div className="flex items-center gap-6">
                            <div className="w-12 h-12 rounded-full border border-accent/20 flex items-center justify-center text-accent/60 font-display text-sm">01</div>
                            <div>
                                <h3 className="text-xl md:text-2xl font-display font-light tracking-[0.2em] uppercase leading-tight">{t('system01.title')}</h3>
                                <p className="text-[11px] md:text-[13px] text-foreground/40 mt-1 tracking-wider uppercase">{t('system01.desc')}</p>
                            </div>
                        </div>
                    ...
                    <div className="space-y-12">
                        <div className="flex items-center gap-6">
                            <div className="w-12 h-12 rounded-full border border-accent/20 flex items-center justify-center text-accent/60 font-display text-sm">02</div>
                            <div>
                                <h3 className="text-xl md:text-2xl font-display font-light tracking-[0.2em] uppercase leading-tight">{t('system02.title')}</h3>
                                <p className="text-[11px] md:text-[13px] text-foreground/40 mt-1 tracking-wider uppercase">{t('system02.desc')}</p>
                            </div>
                        </div>
                            ...
                            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4">
                                {finalGridItems.map((item, idx) => (
                                    ...
                                    >
                                        ...
                                        <span className="text-[8.5px] uppercase tracking-[0.2em] truncate w-full text-center">{item.label}</span>
                                    </button>
                                ))}
                            </div>
                    ...
                    <div className="space-y-12">
                        <div className="flex items-center gap-6">
                            <div className="w-12 h-12 rounded-full border border-accent/20 flex items-center justify-center text-accent/60 font-display text-sm">03</div>
                            <div>
                                <h3 className="text-xl md:text-2xl font-display font-light tracking-[0.2em] uppercase leading-tight">{t('system03.title')}</h3>
                                <p className="text-[11px] md:text-[13px] text-foreground/40 mt-1 tracking-wider uppercase">{t('system03.desc')}</p>
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                            {[
                                ...
                                >
                                    ...
                                    {momentum === mode.id && <div className="absolute inset-0 border-[0.5px] border-accent" />}
                                    <div className="relative z-10 flex flex-col gap-6 h-full">
                                        ...
                                        <p className="text-[9px] text-foreground/30 font-light italic mt-auto leading-relaxed">{mode.desc}</p>
                                    </div>
                                </button>
                            ))}
                        </div>
                    ...
                    <div className="space-y-12">
                        <div className="flex items-center gap-6">
                            <div className="w-12 h-12 rounded-full border border-accent/20 flex items-center justify-center text-accent/60 font-display text-sm">04</div>
                            <div>
                                <h3 className="text-xl md:text-2xl font-display font-light tracking-[0.2em] uppercase leading-tight">{t('system04.title')}</h3>
                                <p className="text-[11px] md:text-[13px] text-foreground/40 mt-1 tracking-wider uppercase">{t('system04.desc')}</p>
                            </div>
                        </div>
                            ...
                            <div className="flex gap-6">
                                {(['Monthly', 'Yearly'] as BillingCycle[]).map((cycle) => (
                                    ...
                                    >
                                        ...
                                        {billingCycle === cycle && <div className="absolute inset-0 border-[0.5px] border-accent" />}
                                    </button>
                                ))}
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                            {[
                                ...
                                >
                                    {support === item.level && <div className="absolute inset-0 border-[0.5px] border-accent" />}
                                        ...
                                        <div className="space-y-4 pt-6 border-t border-white/5">
                                            {item.features.map((f, i) => (
                                                <div key={i} className="flex items-start gap-3">
                                                    ...
                                                    <span className={`text-[8.5px] md:text-[9px] uppercase tracking-wide leading-relaxed ${support === item.level ? 'text-foreground' : 'text-foreground/30'}`}>{f}</span>
                                                </div>
                                            ))}
                                        </div>
                                    </div>
                    ...
                    <div className="space-y-12">
                        <div className="flex items-center gap-6">
                            <div className="w-12 h-12 rounded-full border border-accent/20 flex items-center justify-center text-accent/60 font-display text-sm">05</div>
                            <div>
                                <h3 className="text-xl md:text-2xl font-display font-light tracking-[0.2em] uppercase leading-tight">{t('system05.title')}</h3>
                                <p className="text-[11px] md:text-[13px] text-foreground/40 mt-1 tracking-wider uppercase">{t('system05.desc')}</p>
                            </div>
                        </div>
                            ...
                            {[
                                ...
                                return (
                                    <button
                                        ...
                                        className={`group relative p-6 text-left transition-all duration-700 flex flex-col gap-3 min-h-[100px] justify-between ${addons[addon.id] ? 'bg-accent/[0.08]' : 'bg-background/20 hover:bg-white/[0.02]'}`}
                                    >
                                        {addons[addon.id] && <div className="absolute inset-0 border-[0.5px] border-accent" />}
                                        <div className="space-y-1 relative z-10 w-full">
                                            <div className="flex justify-between items-start gap-4">
                                                <span className={`text-[9px] md:text-[10px] uppercase tracking-[0.2em] font-black leading-tight ${addons[addon.id] ? 'text-accent' : 'text-foreground/60'}`}>
                                                    {ta(`${addon.id}.label`)}
                                                </span>
                                                <span className={`text-[8px] md:text-[9px] font-bold whitespace-nowrap ${addons[addon.id] ? 'text-accent' : 'text-accent/40'}`}>{addon.cost}</span>
                                            </div>
                                            <p className="text-[8.5px] md:text-[9px] text-foreground/30 font-light italic leading-tight">{ta(`${addon.id}.desc`)}</p>
                                        </div>
                                    </button>
                                );
                            })}
            ...
            <div className="absolute bottom-12 left-1/2 -translate-x-1/2 opacity-60 pointer-events-none w-full text-center px-6">
                <span className="text-[8px] md:text-[10px] uppercase tracking-[0.8em] md:tracking-[1.25em] text-accent/80 font-bold -mr-[0.8em] md:-mr-[1.25em] block leading-relaxed">
                    {t('algo_analysis')}
                </span>
            </div>
        </section>
