    ...
    <div class="container">
        <div class="cta-crystal__grid">
            ...
            <div class="cta-crystal__content fade-up is-visible">
                ...
                <h2 class="cta-crystal__title" style="line-height: 1.2;">
                    <span class="text-gradient">Оё барои густариши</span><br>
                    <span class="text-gradient">муваффақияти</span><br>
                    <span class="text-gradient">худ омодаед?</span>
                </h2>
