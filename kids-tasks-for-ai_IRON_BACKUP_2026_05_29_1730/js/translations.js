...
const TRANSLATIONS = {
    tg: {
        ...
        'balance.currency.sm': 'смн',
        'balance.currency.somoni': 'сомонӣ',
        'balance.star': 'ситорача',
        'balance.stars': 'ситорача',
        'balance.income': 'Даромад',
        'balance.deducted': 'Тарҳ',
        'balance.withdrawn': 'Бароварда',
        'balance.no_withdrawals': 'Ҳанӯз пул бароварда нашудааст',
        'balance.no_tests': 'Ҳанӯз санҷише гузаронида нашудааст',
        'balance.not_enough': 'Барои баровардан пул кофӣ нест!',
        'balance.withdraw_success': 'сомонӣ бароварда шуд!',
        'balance.withdraw_title': 'Баровардани пул',
        'balance.withdraw_how_much': 'Чанд сомонӣ мехоҳед бароред?',
        ...
        'balance.withdraw_error_balance': 'Пули кофӣ нест!',
        'balance.stars_only': 'Ситорачаҳо',
        'balance.stars_and_money': 'Пулу ситорача',

        // Reward type
        'reward.type': 'Намуди мукофот',
        'reward.money': '💰 Пул (сомонӣ)',
        ...
        'confirm.question': 'Оё вазифаи {emoji} {name} иҷро шудааст?',
        ...
        // Task Form
        'task_form.title_new': '➕ Вазифаи нав',
        'task_form.title_edit': '✏️ Тағйири вазифа',
        'task_form.title_new_bonus': '🎁 Вазифаи бонусии нав',
        'task_form.name': 'Номи вазифа',
        'task_form.name_placeholder': 'Номи вазифаро ворид кунед',
        'task_form.duration': 'Вақт (дақиқа)',
        'task_form.emoji': 'Эмодзи',
        'task_form.emoji_placeholder': '🎯',
        'task_form.is_bonus': 'Вазифаи бонусӣ',
        'task_form.bonus_price': 'Нарх (сомонӣ)',
        'task_form.deadline': 'Мӯҳлат (ихтиёрӣ)',
        'task_form.deadline_none': 'Мӯҳлат надорад',
        'task_form.error_name': 'Номи вазифаро ворид кунед!',
    ...
    ru: {
        ...
        'balance.currency.sm': 'сом',
        'balance.currency.somoni': 'сомони',
        'balance.star': 'звезда',
        'balance.stars': 'звёзд',
        ...
        'balance.not_enough': 'Недостаточно средств для снятия!',
        'balance.withdraw_success': 'сомони снято!',
        'balance.withdraw_title': 'Снять деньги',
        'balance.withdraw_how_much': 'Сколько сомони хотите снять?',
        'balance.withdraw_current': 'Текущий баланс:',
        'balance.withdraw_amount': 'Сумма...',
        'balance.withdraw_error_amount': 'Введите правильную сумму!',
        'balance.withdraw_error_balance': 'Недостаточно средств!',
        'balance.stars_only': 'Звёзды',
        'balance.stars_and_money': 'Деньги и звёзды',

        // Reward type
        'reward.type': 'Тип награды',
        'reward.money': '💰 Деньги (сомони)',
        'reward.stars': '⭐ Звёзды',
        ...
        'confirm.question': 'Задание {emoji} {name} выполнено?',
        'confirm.pin_placeholder': '****',
        ...
        'task_form.duration': 'Время (минуты)',
        'task_form.emoji': 'Эмодзи',
        'task_form.emoji_placeholder': '🎯',
        'task_form.is_bonus': 'Бонусное задание',
