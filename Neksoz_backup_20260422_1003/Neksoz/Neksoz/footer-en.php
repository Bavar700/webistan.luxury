...
<footer class="footer-platinum">
    ...
    <div class="container" style="position:relative; z-index:10;">
        <div class="footer-minimal">
            ...
            <nav class="footer-minimal__nav footer-nav--icons fade-up">
                <a href="<?php echo home_url('/?lang=en'); ?>">
                ...
                <a href="<?php echo home_url('/services?lang=en'); ?>">
                ...
                <a href="<?php echo home_url('/team?lang=en'); ?>">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>
                    Team
                </a>
                <a href="<?php echo home_url('/news?lang=en'); ?>">
                ...
                <a href="<?php echo home_url('/contacts?lang=en'); ?>">
    ...
    <div class="container" style="position:relative; z-index:10;">
        <div class="footer-platinum__bottom">
            <p>&copy; <?php echo date('Y'); ?> NEKSOZ. All rights reserved.</p>
            <div class="footer-platinum__legal">
                <a href="<?php echo home_url('/privacy-policy?lang=en'); ?>">Privacy Policy</a>
                <a href="<?php echo home_url('/terms?lang=en'); ?>">Terms of Service</a>
            </div>
        </div>
    </div>
</footer>
                    ...
                    <form action="#" class="cta-crystal__form">
                        ...
                        <div class="cta-crystal__field nx-dropdown" id="modalDropdown">
                            ...
                            <div class="nx-dropdown__panel">
                                ...
                                <div class="nx-dropdown__option" data-val="secretariat">Services секретариата</div>
                        ...
                        <p style="font-size: 11px; color: var(--nk-gray-500); text-align: center; margin-top: 15px; line-height: 1.4; opacity: 0.8; width: 100%;">
                            By clicking the button, you agree with the <a href="<?php echo home_url('/privacy-policy?lang=en'); ?>" style="color: var(--nk-blue); text-decoration: underline;">Privacy Policy</a>
                        </p>
                    </form>
                </div>
            </div>
