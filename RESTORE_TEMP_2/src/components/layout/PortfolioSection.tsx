...
className="group relative bg-card-bg text-card-text p-16 hover:bg-surface/80 transition-all duration-1000 overflow-hidden shadow-xl rounded-lg border border-separator/10" > {
