	...
	<div class="py-16 sm:py-24">
		<div class="mx-auto max-w-4xl px-6">
			...
			<div class="prose prose-lg prose-headings:font-serif prose-headings:font-medium prose-p:font-light prose-a:text-primary hover:prose-a:text-gray-900 transition-colors mx-auto text-gray-600">
				<p><?php echo tr('ethnography_main_desc'); ?></p>
				
				<h3><?php echo tr('ethnography_sec1_title'); ?></h3>
				<p><?php echo tr('ethnography_sec1_content'); ?></p>

				<h3><?php echo tr('ethnography_sec2_title'); ?></h3>
				<p><?php echo tr('ethnography_sec2_content'); ?></p>

				<h3><?php echo tr('ethnography_sec3_title'); ?></h3>
				<p><?php echo tr('ethnography_sec3_content'); ?></p>

				<h3><?php echo tr('ethnography_sec4_title'); ?></h3>
				<p><?php echo tr('ethnography_sec4_content'); ?></p>
			</div>
