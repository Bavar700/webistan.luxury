        ...
        <div class="container hero__container" style="position:relative;z-index:2;">
            <div class="hero__content">
                ...
                <h1 class="hero__title">
                    Комплексные<br>
                    <span class="text-gradient">услуги для роста</span><br>
                    <span style="color: var(--nk-blue);">вашего бизнеса</span>
                </h1>
                <p class="hero__desc">
...
if (function_exists('nk_get_current_lang')) {
 ...
 echo home_url('/contacts'); ?>" class="btn btn--primary">Консультация</a>
            </div>
        </div>
    </section>
...
if (function_exists('nk_get_current_lang')) {
 ...
 echo home_url('/service-audit'); ?>" class="service-card__link">Подробнее →</a>
                </div>
...
if (function_exists('nk_get_current_lang')) {
 ...
 echo home_url('/service-restore'); ?>" class="service-card__link">Подробнее →</a>
                </div>
...
if (function_exists('nk_get_current_lang')) {
 ...
 echo home_url('/service-legal'); ?>" class="service-card__link">Подробнее →</a>
                </div>
...
if (function_exists('nk_get_current_lang')) {
 ...
 echo home_url('/service-accounting'); ?>" class="service-card__link">Подробнее →</a>
                </div>
...
if (function_exists('nk_get_current_lang')) {
 ...
 echo home_url('/service-secretariat'); ?>" class="service-card__link">Подробнее →</a>
                </div>
...
if (function_exists('nk_get_current_lang')) {
 ...
 echo home_url('/service-consulting'); ?>" class="service-card__link">Подробнее →</a>
                </div>
...
if (function_exists('nk_get_current_lang')) {
 ...
 echo home_url('/service-tax'); ?>" class="service-card__link">Подробнее →</a>
                </div>
...
if (function_exists('nk_get_current_lang')) {
 ...
 echo home_url('/service-management'); ?>" class="service-card__link">Подробнее →</a>
                </div>
...
if (function_exists('nk_get_current_lang')) {
 ...
 echo home_url('/service-automation'); ?>" class="service-card__link">Подробнее →</a>
                </div>
            </div>
        </div>
    </section>
