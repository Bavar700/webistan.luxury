        ...
        <section id="services" className="py-[125px] bg-background relative overflow-hidden scroll-mt-32">
            <div className="container mx-auto px-6 relative z-10 max-w-7xl">
                <div className="max-w-4xl mx-auto text-center mb-24 flex flex-col items-center">
                    ...
                    >
                        <span className="text-sm md:text-lg font-display font-medium tracking-[1.05em] text-foreground/70 uppercase block leading-none -mr-[1.05em]">
                            {t('subheading')}
                        </span>
                ...
                >
                    {[
                        ...
                        <motion.div
                            ...
                            className="group relative bg-background p-12 hover:bg-white/[0.01] transition-all duration-1000 overflow-hidden"
                        >
                            {/* Glass Shine effect */}
                            ...
                            <div className="relative z-10 text-center flex flex-col items-center">
                                <div className="space-y-4 w-full">
                                    <span className="text-[9px] md:text-[10px] font-display uppercase tracking-[0.6em] text-accent/80 block italic -mr-[0.6em] font-bold animate-pulse">{t('layer_label')} 0{i + 1}</span>
