                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-32">
                            ...
                            <motion.div variants={itemVariants} className="space-y-16">
                                <div className="group cursor-pointer flex gap-12 items-start transition-all duration-700 hover:translate-x-4">
                                    <div className="p-5 bg-white/[0.01] flex items-center justify-center relative group-hover:bg-accent/[0.03] transition-all duration-1000">
                                        ...
                                        <div className="absolute top-0 right-0 w-2 h-2 border-t-[0.5px] border-r-[0.5px] border-accent/20 group-hover:border-accent" />
                                        <div className="absolute bottom-0 left-0 w-2 h-2 border-b-[0.5px] border-l-[0.5px] border-accent/20 group-hover:border-accent" />
                        ...
                        >
                            <div className="bg-white/[0.01] p-12 md:p-24 relative group/form overflow-hidden transition-all duration-1000">
                                <div className="absolute top-0 left-0 w-16 h-16 border-t-[0.5px] border-l-[0.5px] border-accent/40 group-hover/form:w-20 group-hover/form:h-20 transition-all duration-1000" />
                                <div className="absolute top-0 right-0 w-16 h-16 border-t-[0.5px] border-r-[0.5px] border-accent/40 group-hover/form:w-20 group-hover/form:h-20 transition-all duration-1000" />
                                <div className="absolute bottom-0 left-0 w-16 h-16 border-b-[0.5px] border-l-[0.5px] border-accent/40 group-hover/form:w-20 group-hover/form:h-20 transition-all duration-1000" />
                                <div className="absolute bottom-0 right-0 w-16 h-16 border-b-[0.5px] border-r-[0.5px] border-accent/40 group-hover/form:w-20 group-hover/form:h-20 transition-all duration-1000" />
                                ...
                                <form onSubmit={handleSubmit} className="space-y-16">
                                    ...
                                    <div className="p-10 bg-white/[0.01] mb-20 relative overflow-hidden group/plate transition-all duration-1000">
                                        ...
                                        <div className="absolute top-0 right-0 w-4 h-4 border-t-[0.5px] border-r-[0.5px] border-accent/10 group-hover/plate:border-accent/40 transition-colors" />
                                        <div className="absolute bottom-0 left-0 w-4 h-4 border-b-[0.5px] border-l-[0.5px] border-accent/10 group-hover/plate:border-accent/40 transition-colors" />
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-20">
                                        <div className="space-y-6 relative group/input p-4">
                                            ...
                                            <div className="absolute top-0 right-0 w-2 h-2 border-t-[0.5px] border-r-[0.5px] border-accent/5 group-focus-within/input:border-accent group-hover/input:border-accent/30 transition-colors" />
                                            <div className="absolute bottom-0 left-0 w-2 h-2 border-b-[0.5px] border-l-[0.5px] border-accent/5 group-focus-within/input:border-accent group-hover/input:border-accent/30 transition-colors" />
                                    ...
                                    <div className="space-y-6 relative group/input p-4">
                                        ...
                                        <div className="absolute top-0 right-0 w-3 h-3 border-t-[0.5px] border-r-[0.5px] border-accent/5 group-focus-within/input:border-accent group-hover/input:border-accent/30 transition-colors" />
                                        <div className="absolute bottom-0 left-0 w-3 h-3 border-b-[0.5px] border-l-[0.5px] border-accent/5 group-focus-within/input:border-accent group-hover/input:border-accent/30 transition-colors" />
