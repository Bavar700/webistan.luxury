<?php
/**
 * Template Name: service-secretariat
 */
if (function_exists('nk_get_current_lang')) {
    $lang = nk_get_current_lang();
    if ($lang === 'tj') { get_template_part('service-secretariat', 'tj'); return; }
    if ($lang === 'en') { get_template_part('service-secretariat', 'en'); return; }
}
get_header();
?>
        ...
        <div class="container">
            ...
            <div class="services-grid" style="grid-template-columns: repeat(2, 1fr); gap: 40px;">
                ...
                <div class="service-card" style="height: 100%;">
                    ...
                    <h3 class="service-card__title">Когда нужна <br>поддержка?</h3></div>
