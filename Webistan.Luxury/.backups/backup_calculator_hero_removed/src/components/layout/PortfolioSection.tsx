    ...
    return (
        <section id="portfolio" className="py-[125px] bg-background relative overflow-hidden">
                        ...
                        >
                            ...
                            <div className="relative z-10 text-center flex flex-col items-center">
                                <div className="space-y-4 w-full">
                                    <span className="text-[9px] md:text-[10px] font-display uppercase tracking-[0.6em] text-accent/80 block italic -mr-[0.6em] font-bold animate-pulse">{t('protocol_label')} 0{i + 1}</span>
            ...
            <div className="absolute bottom-12 left-1/2 -translate-x-1/2 opacity-60 pointer-events-none w-full text-center px-6">
                <span className="text-[8px] md:text-[10px] uppercase tracking-[0.8em] md:tracking-[1.25em] text-accent/80 font-bold -mr-[0.8em] md:-mr-[1.25em] block leading-relaxed italic">
                    {t('genesis_protocol')}
                </span>
            </div>
        </section>
