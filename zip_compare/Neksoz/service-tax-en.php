...
<main class="site-main">
        ...
        <div class="container hero__container" style="position:relative;z-index:2;">
            <div class="hero__content">
                ...
                <h1 class="hero__title">
                    Expert tax<br>
                    <span class="text-gradient">consultations for business</span>
                </h1>
                <p class="hero__desc">
    ...
    <section class="section">
        <div class="container">
            <div class="section__header section__header--center" style="margin-bottom: 60px;">
                <div class="section__label">Tax Security</div>
                <h2 class="section__title">Your Legal Path to Savings</h2>
                <p class="section__subtitle">We help you pay taxes correctly, eliminating overpayments and protecting against claims from fiscal authorities.</p>
            </div>
            ...
            <div class="services-grid" style="grid-template-columns: repeat(2, 1fr); gap: 40px;">
                ...
                <div class="service-card" style="height: 100%;">
                    ...
                    <h3 class="service-card__title">When are consultations needed?</h3></div>
                    <div class="service-card__tasks">
                        <ul class="service-card__list">
                            <li>You believe you are overpaying taxes</li>
                            <li>Preparation for a tax audit is required</li>
                            <li>A complex dispute with the inspectorate has arisen</li>
                            <li>A transaction with major risks is planned</li>
                            <li>Calculation of the consequences of new projects is needed</li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="service-card" style="height: 100%;">
                    ...
                    <h3 class="service-card__title">What does the service include?</h3></div>
                    <div class="service-card__tasks">
                        <ul class="service-card__list">
                            <li>Tax consultations (for legal entities and individuals)</li>
                            <li>Development of an effective tax policy</li>
                            <li>Checking compliance with legislation</li>
                            <li>Representation in tax disputes</li>
                            <li>Optimization of tax payments within the law</li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="service-card" style="height: 100%;">
                    ...
                    <div class="service-card__tasks">
                        <ul class="service-card__list">
                            <li>In-depth analysis of the current tax model</li>
                            <li>Finding legal ways to reduce the burden</li>
                            <li>Eliminating errors that attract attention</li>
                            <li>Protecting the client's interests in authorities</li>
                            <li>Full support during audits</li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="service-card" style="height: 100%;">
                    ...
                    <h3 class="service-card__title">Results for your business</h3></div>
                    <div class="service-card__tasks">
                        <ul class="service-card__list">
                            <li>Reduction of tax payments (legally)</li>
                            <li>Security before state audits</li>
                            <li>Confidence in every somoni of deductions</li>
                            <li>Absence of blockages and claims from authorities</li>
                            <li>Clean credit and tax history</li>
                        </ul>
                    </div>
                </div>
    ...
    <section id="lead-form" class="section section--gray" style="border-top: 1px solid var(--nk-gray-100); padding-top: 40px; padding-bottom: 80px;">
        <div class="container" style="max-width: 800px;">
            <div class="section__header section__header--center" style="margin-bottom: 60px;">
                <div class="section__label">Tax Audit</div>
                <h2 class="section__title">Free Express Assessment</h2>
                <p class="section__subtitle" style="margin-bottom: 0;">Leave a request for a preliminary analysis of your tax burden.<br>We will contact you within 30 minutes.</p>
            </div>
                ...
                <form class="cta-crystal__form" action="#" method="POST" style="display: grid; gap: 24px;">
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 24px;">
                        <div class="cta-crystal__field">
                            ...
                            <label for="tc-name">Your Name</label>
                        </div>
                        <div class="cta-crystal__field">
                            <input type="tel" placeholder=" " required id="tc-phone">
                            <label for="tc-phone">Phone (+992)</label>
                        </div>
                    </div>
                    <div class="cta-crystal__field">
                        <input type="text" placeholder=" " id="tc-company">
                        <label for="tc-company">Company Name (Optional)</label>
                    </div>
                    <button type="submit" class="cta-crystal__btn"><span>Start Optimization</span><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M5 12h14"/><path d="m12 5 7 7-7 7"/></svg></button>
