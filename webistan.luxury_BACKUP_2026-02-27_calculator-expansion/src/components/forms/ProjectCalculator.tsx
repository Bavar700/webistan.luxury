                ...
                <div className="max-w-4xl mx-auto bg-white/[0.01] p-10 md:p-20 space-y-32 relative group/calc">
                    ...
                    <div className="space-y-12">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                { id: 'branding' as const, label: 'Visual Identity', desc: 'Logo + Guidelines', cost: '1,750 TJS' },
                                { id: 'infrastructure' as const, label: 'Digital Infrastructure', desc: 'Domain + 1Y Hosting', cost: '1,000 TJS' },
                                { id: 'seo' as const, label: 'Search Calibration', desc: 'Keyword Architecture', cost: '2,000 TJS' },
                                { id: 'ai' as const, label: 'Neural Integration', desc: 'LLM Protocol', cost: '3,750 TJS' },
                                { id: 'ads' as const, label: 'Direct Advertising', desc: 'Google/Yandex Ads', cost: '3,000 TJS' },
                                { id: 'smm' as const, label: 'SMM Protocol', desc: 'Social Reach Audit', cost: '2,500 TJS' },
                                { id: 'adsense' as const, label: 'AdSense Stream', desc: 'Monetization Link', cost: '1,500 TJS' },
                                { id: 'maps' as const, label: 'Global Mapping', desc: 'Google Maps Link', cost: '1,000 TJS' }
                            ].map((addon) => (
                                <button
                                    key={addon.id}
                                ...
                                >
                                    ...
                                    <div className="flex justify-between items-start gap-4 z-10 w-full">
                                        ...
                                        <span className={`text-[9px] font-bold tracking-widest ${addons[addon.id] ? 'text-accent' : 'text-accent/40'}`}>{addon.cost}</span>
                                    </div>
