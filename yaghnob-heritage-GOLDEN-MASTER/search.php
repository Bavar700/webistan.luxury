		...
		<div class="relative z-10 mx-auto max-w-7xl px-6 text-center">
			...
			<div class="flex flex-wrap justify-center gap-4 text-xs font-bold uppercase tracking-widest text-gray-500 mb-6" data-aos="fade-up">
				<span class="text-primary hover:text-gray-900 transition-colors">
					<?php echo yaghnob_tr('search_results'); ?>
				</span>
			</div>
			...
			<h1 class="text-3xl sm:text-4xl lg:text-5xl font-serif font-medium text-gray-900 leading-tight" data-aos="fade-up" data-aos-delay="100">
				<?php printf( yaghnob_tr('search_results_for'), '<span>' . get_search_query() . '</span>' ); ?>
			</h1>
		...
		<div class="mx-auto max-w-7xl px-6 lg:px-8">
			...
			<?php if ( have_posts() ) : ?>
				...
				<div class="mt-16 flex justify-center">
					...
					the_posts_pagination(
						array(
							'mid_size'  => 2,
							'prev_text' => yaghnob_tr('pagination_previous'),
							'next_text' => yaghnob_tr('pagination_next'),
							'class'     => 'flex gap-2',
						)
					);
					?>
			...
			<?php else : ?>
				...
				<div class="text-center py-24">
					<h2 class="text-2xl font-serif font-medium text-gray-900 mb-4"><?php echo yaghnob_tr('no_results_found'); ?></h2>
					<p class="text-gray-600 mb-8"><?php echo yaghnob_tr('no_results_text'); ?></p>
					<?php get_search_form(); ?>
				</div>
