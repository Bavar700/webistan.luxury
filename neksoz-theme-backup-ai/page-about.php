...
if (function_exists('nk_get_current_lang')) {
 ...
 echo home_url('/team'); ?>" class="btn btn--primary btn-animated">
    ...
    <section class="section" style="padding-top: 80px; padding-bottom: 80px;">
        <div class="container">
            <div class="section__header section__header--center" style="margin-bottom: 60px;">
                ...
                <p class="section__subtitle">За <?php
if (function_exists('nk_get_current_lang')) {
    $lang = nk_get_current_lang();
    if ($lang === 'tj') { get_template_part('page-about', 'tj'); return; }
    if ($lang === 'en') { get_template_part('page-about', 'en'); return; }
}
 echo (date('Y') - 2016); ?> лет работы на рынке Таджикистана мы прошли путь от амбициозной команды до признанного лидера в области бухгалтерского консалтинга в Таджикистане.</p>
            </div>
