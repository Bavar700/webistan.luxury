...
if (function_exists('nk_get_current_lang') && nk_get_current_lang() === 'en' && !get_query_var('is_footer_en')) {
...
<footer class="footer-platinum">
    ...
    <div class="container" style="position:relative; z-index:10;">
        <div class="footer-minimal">
            ...
            <div class="footer-minimal__logo fade-up">
                <img src='<?php echo get_template_directory_uri(); ?>/logo.png' alt="NEKSOZ"
            ...
            $current_labels = isset($qr_labels[$current_lang]) ? $qr_labels[$current_lang] : $qr_labels['ru'];
            ?>
            ...
            <div class="footer-platinum__social-hub fade-up" style="margin: 40px 0 0 0;">
                <div class="footer-platinum__socials">
                    ...
                    <a href="#" class="footer-platinum__social-btn" title="X (Twitter)" aria-label="X (Twitter)">
                        <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                            stroke-width="2.5">
                    ...
                    <a href="tel:+992446000000" class="footer-platinum__social-btn" title="Позвонить"
                        aria-label="<?php esc_attr_e('Позвонить', 'neksoz'); ?>">
                        <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                            stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                            <path
    ...
    <div class="container" style="position:relative; z-index:10;">
        <div class="footer-platinum__bottom">
            <p>&copy; <?php echo date('Y'); ?> NEKSOZ.
                <?php if (function_exists('pll_e'))
                    pll_e('Все права защищены.');
                else
                    _e('Все права защищены.', 'neksoz'); ?>
            </p>
            <p
                style="opacity: 0.6; font-size: 11px; letter-spacing: 0.1em; text-transform: uppercase; font-family: var(--font-display);">
                Designed by <a href="https://webistan.luxury" target="_blank"
                    style="color: var(--nk-red); font-weight: 800; text-decoration: none;">WEBISTAN<span
                        style="color: inherit; font-weight: 400;">.LUXURY</span></a></p>
            <div class="footer-platinum__legal">
                ...
                if (has_nav_menu('legal')) {
                    ...
                    // FALLBACK: Original links
                    $current_lang = function_exists('nk_get_current_lang') ? nk_get_current_lang() : 'ru';
                    ?>
                    <a
                        href="<?php echo nk_link('/privacy-policy', $current_lang); ?>"><?php _e('Конфиденциальность', 'neksoz'); ?></a>
                    <a href="<?php echo nk_link('/terms', $current_lang); ?>"><?php _e('Условия', 'neksoz'); ?></a>
                    <?php
                }
                ?>
            </div>
...
<div class="map-modal" id="footerMapModal">
    ...
    <div class="map-modal__container">
        <button class="map-modal__close" id="closeFooterMapBtn"
            aria-label="<?php esc_attr_e('Закрыть карту', 'neksoz'); ?>">
        ...
        <div class="map-modal__content">
            ...
            <div class="map-modal__marker">
                <svg class="map-modal__marker-icon" viewBox="0 0 24 24" fill="currentColor">
                    <path
...
<div class="modal" id="requestModal">
    ...
    <div class="modal__container">
        <button class="modal__close" id="closeRequestBtn" aria-label="<?php esc_attr_e('Закрыть форму', 'neksoz'); ?>">
        ...
        <div class="modal__content" style="padding: 0;">
            <div class="cta-crystal__grid">
                ...
                <div class="cta-crystal__content">
                    <h3 class="cta-crystal__title"><span class="text-gradient">Готовы масштабировать</span><br>свой
                        успех?</h3>
                    <p class="cta-crystal__text">Оставьте заявку сегодня, и мы разработаем для вас персональную
                        стратегию развития вашего бизнеса.</p>
                </div>

                <!-- Right Side: Form -->
                <div class="cta-crystal__form-wrapper">
                    <form action="#" class="cta-crystal__form" id="nkMainLeadForm">
                        <!-- Honeypot Field (Spam Protection) -->
                        <div style="display:none !important;">
                            <input type="text" name="nk_hp" id="nk_hp" tabindex="-1" autocomplete="off">
                        </div>

                        <div class="cta-crystal__field">
                            <input type="text" name="m_name" placeholder=" " required id="m-f-name">
                            <label for="m-f-name">Ваше имя</label>
                        </div>
                        <div class="cta-crystal__field">
                            <input type="tel" name="m_phone" placeholder=" " required id="m-f-phone">
                            <label for="m-f-phone">Телефон (+992)</label>
                        </div>
                        <div class="cta-crystal__field nx-dropdown" id="modalDropdown">
                            <input type="text" name="m_service" placeholder=" " required id="m-f-service-input"
                                class="nx-dropdown__trigger" readonly>
                            <label for="m-f-service-input">Выбрать направление <svg width="12" height="12"
                        ...
                        <div class="cta-crystal__field">
                            <textarea name="m_message" placeholder=" " id="m-f-msg" rows="3"></textarea>
                        ...
                        <p
                            style="font-size: 11px; color: var(--nk-gray-500); text-align: center; margin-top: 15px; line-height: 1.4; opacity: 0.8; width: 100%;">
                            Нажимая кнопку, вы соглашаетесь с <a
                                href="<?php echo nk_link('/privacy-policy', $current_lang); ?>"
                                style="color: var(--nk-blue); text-decoration: underline;">Политикой
