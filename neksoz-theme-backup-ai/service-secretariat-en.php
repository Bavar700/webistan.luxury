<?php
/**
 * Template Name: Service: Secretariat (EN)
 */
get_header();
?>
...
<main class="site-main">
    ...
    <section class="hero hero--internal">
        ...
        <div class="container hero__container" style="position:relative;z-index:2;">
            <div class="hero__content">
                <div class="hero__badge">Department of Visa & Secretariat</div>
                <h1 class="hero__title">
                    Visa Support &<br>
                    <span class="text-gradient">Professional Secretariat</span><br>
                    <span style="color: var(--nk-blue);">Services</span>
                </h1>
                <p class="hero__desc">
                    Comprehensive migration support and administrative assistance for international specialists and representative offices in Tajikistan.
                </p>
            </div>
    ...
    <section class="section">
        <div class="container">
            <div class="section__header section__header--center" style="margin-bottom: 60px;">
                <div class="section__label">Immigration & Flow</div>
                <h2 class="section__title">Legal Mobility for Your Global Team</h2>
                <p class="section__subtitle">We handle the bureaucracy, so your international talent can focus on contributing to your project.</p>
            </div>

            <div class="services-grid" style="grid-template-columns: repeat(2, 1fr); gap: 40px;">
                
                <!-- CARD 1: When is support needed? -->
                <div class="service-card service-card--alt" style="height: 100%;">
                    ...
                    <h3 class="service-card__title">When is <br>Support Needed?</h3>
                    <div class="service-card__tasks">
                        <ul class="service-card__list">
                            <li>Attracting international specialists</li>
                            <li>Processing business visas (Type M)</li>
                            <li>Extending registration (OVIR)</li>
                            <li>Working with Dipservice (Type K)</li>
                            <li>Professional translation of legal documents</li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="service-card" style="height: 100%;">
                    ...
                    <div class="service-card__tasks">
                        <ul class="service-card__list">
                            <li>Quotas for hiring foreign citizens (MLME)</li>
                            <li>Processing invitations and work permits</li>
                            <li>Visa extensions (Types M, K, O-2, etc.)</li>
                            <li>Obtaining ID cards from Dipservice</li>
                            <li>Professional notarized document translation</li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="service-card service-card--alt" style="height: 100%;">
                    ...
                    <div class="service-card__tasks">
                        <ul class="service-card__list">
                            <li>Defining visa type and checklist</li>
                            <li>Document review for legislative compliance</li>
                            <li>Submission to state authorities</li>
                            <li>Interaction with Migration Services</li>
                            <li>Delivery of finalized permits to the client</li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="service-card" style="height: 100%;">
                    ...
                    <div class="service-card__tasks">
                        <ul class="service-card__list">
                            <li>Legal status for all foreign staff members</li>
                            <li>No risks of legislative/migration violations</li>
                            <li>Reduced administrative burden on management</li>
                            <li>Fast processing of permits and passes</li>
                            <li>Correctly translated and notarized documents</li>
                        </ul>
                    </div>
                </div>
    ...
    <section id="lead-form" class="section section--gray" style="border-top: 1px solid var(--nk-gray-100); padding-top: 40px; padding-bottom: 80px;">
        <div class="container" style="max-width: 800px;">
            <div class="section__header section__header--center" style="margin-bottom: 60px;">
                <div class="section__label">Visa Assessment</div>
                <h2 class="section__title">Free Express Consultation</h2>
                <p class="section__subtitle" style="margin-bottom: 0;">Leave a request for a preliminary migration assessment. We will contact you within 30 minutes.</p>
            </div>
            ...
            <div class="cta-crystal__form-box" style="background: var(--nk-white); padding: 60px; border-radius: 32px; box-shadow: 0 40px 100px rgba(0, 13, 51, 0.08); border: 1px solid var(--nk-gray-50);">
                <form class="cta-crystal__form" action="#" method="POST" style="display: grid; gap: 24px;">
                    ...
                    <button type="submit" class="cta-crystal__btn"><span>Consult an Expert</span><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M5 12h14"/><path d="m12 5 7 7-7 7"/></svg></button>
