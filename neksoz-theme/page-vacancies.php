        ...
        <div class="container hero__container">
            <div class="hero__content" style="max-width: 850px;">
                ...
                <h1 class="hero__title">
                    Ваша точка<br>
                    <span class="text-gradient">профессионального</span><br>
                    <span style="color: var(--nk-blue);">роста</span>
                </h1>
                <p class="hero__desc" style="max-width: 550px; font-size: 1rem; opacity: 0.9;">
                    Мы объединяем таланты для создания интеллектуальных решений в сфере аудита, финансов и права. Станьте частью команды, которая задает стандарты качества в Таджикистане.
                </p>
            </div>
            ...
            <div class="hero__actions--right">
                ...
                <a href="#apply" class="btn btn--outline-light btn-animated-light">Отправить резюме</a>
            </div>
        </div>
    </section>
    ...
    <section class="section">
        <div class="container vac-container">
            <div class="section__header section__header--center fade-up" style="margin-bottom: 80px;">
                ...
                <p class="section__subtitle" style="color:var(--nk-gray-400);">Инвестиции в ваш интеллект и карьеру — наш главный приоритет.</p>
            </div>
            ...
            <div class="vac-accordion fade-up">
                ...
                <div class="vac-item">
                    <div class="vac-header">
                        <div style="display: flex; align-items: center;">
                            <span class="vac-header__title">Помощник бухгалтера (Junior Accountant)</span>
                    ...
                    <div class="vac-content">
                        <div class="vac-content__inner">
                            <div>
                                <h4 class="vac-section-title">О позиции</h4>
                                ...
                                <ul class="vac-list">
                                    ...
                                    <li>Работа в 1С 8.3 и внесение данных в CRM-систему</li>
                                    <li>Подготовка документов для архивного хранения</li>
                                </ul>
                            </div>
                            <div>
                                <h4 class="vac-section-title">Наши ожидания</h4>
                                <ul class="vac-list">
                                    ...
                                    <li>Владение русским и таджикским языками</li>
                                </ul>

                                <h4 class="vac-section-title" style="margin-top: 30px;">Условия</h4>
                                <ul class="vac-list">
                                    <li>График: 08:00 — 17:00 (5/2)</li>
                        ...
                        <div style="margin-top: 40px; text-align: right;">
                            <a href="#apply" class="btn btn--blue" style="padding: 12px 28px; font-size: 11px;">Откликнуться на вакансию</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="simple-card fade-up" style="background: var(--nk-gray-50); border: 1px dashed var(--nk-gray-200); margin-top: 40px; text-align: center;">
                    <h4 style="font-family: var(--font-display); margin-bottom: 15px;">Не нашли подходящую вакансию?</h4>
                    <p style="color: var(--nk-gray-600); max-width: 600px; margin: 0 auto 24px;">Мы всегда заинтересованы в сильных аудиторах, юристах и консультантах. Если вы профессионал своего дела — отправьте резюме, и мы свяжемся с вами.</p>
            ...
            <div class="section__header section__header--center fade-up">
                ...
                <h2 class="section__title">Этапы отбора</h2>
            </div>
            ...
            <div class="stages-grid fade-up">
                <div class="stage-item">
                    ...
                    <p class="stage-item__text">Изучаем ваш опыт в течение 2-3 дней.</p>
                </div>
                <div class="stage-item">
                    ...
                    <p class="stage-item__text">Короткое задание на логику или знания.</p>
                </div>
                <div class="stage-item">
                    ...
                    <p class="stage-item__text">Знакомство с HR и руководителем.</p>
                </div>
                <div class="stage-item">
                    ...
                    <p class="stage-item__text">Добро пожаловать в Neksoz!</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section id="apply" class="section cta-crystal" style="padding: 120px 0; background: var(--nk-gray-50); position: relative; overflow: hidden;">
        ...
        <div class="container fade-up" style="position: relative; z-index: 5;">
            <div class="section__header section__header--center">
                ...
                <h2 class="section__title">Присоединяйтесь к команде</h2>
                <p class="section__subtitle">Заполните анкету и прикрепите ваше резюме. Мы свяжемся с вами для назначения интервью.</p>
            </div>
                ...
                <form action="#" class="cta-crystal__form">
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 24px; margin-bottom: 24px;">
                        <div class="cta-crystal__field">
                            ...
                            <label for="app-name">ФИО</label>
                        </div>
                        <div class="cta-crystal__field">
                            <input type="email" placeholder=" " required id="app-email">
                            <label for="app-email">Эл. почта</label>
                        </div>
                    </div>
