<?php
/**
 * Single Post / Service Template — Neksoz.Luxury
 *
 * @package Neksoz
 */
        ...
        <div class="nk-container">
            <div style="max-width: 700px;">
                <?php if ( 'neksoz_service' === get_post_type() ) : ?>
                    <span class="section-label" style="color: rgba(255,255,255,0.5);"><?php esc_html_e( 'Услуги', 'neksoz' ); ?></span>
                <?php else : ?>
                    <span class="section-label" style="color: rgba(255,255,255,0.5);"><?php esc_html_e( 'Новости', 'neksoz' ); ?></span>
                <?php endif; ?>
                ...
                <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
                    ...
                    <div style="margin-top: 3rem; display: flex; justify-content: space-between; gap: 2rem;">
                        <div>
                            ...
                            ?>
                                <span style="display: block; font-size: 0.75rem; text-transform: uppercase; letter-spacing: 0.1em; color: var(--nk-text-muted); margin-bottom: 0.25rem;">
                                    <?php esc_html_e( '← Предыдущая', 'neksoz' ); ?>
                                </span>
                        ...
                        <div style="text-align: right;">
                            ...
                            ?>
                                <span style="display: block; font-size: 0.75rem; text-transform: uppercase; letter-spacing: 0.1em; color: var(--nk-text-muted); margin-bottom: 0.25rem;">
                                    <?php esc_html_e( 'Следующая →', 'neksoz' ); ?>
                                </span>
                ...
                <aside class="nk-sidebar" style="position: sticky; top: 100px;">
                    <?php if ( 'neksoz_service' === get_post_type() ) : ?>
                        ...
                        <div style="background: var(--nk-bg-alt); padding: 1.5rem; border-radius: var(--nk-card-radius);">
                            <h4 style="font-size: 1rem; margin-bottom: 1rem;"><?php esc_html_e( 'Другие услуги', 'neksoz' ); ?></h4>
                            <?php
                    ...
                    <div style="margin-top: 2rem; padding: 2rem; background: var(--nk-primary-dark); border-radius: var(--nk-card-radius); text-align: center;">
                        <h4 style="color: #fff; font-size: 1rem; margin-bottom: 0.75rem;"><?php esc_html_e( 'Нужна консультация?', 'neksoz' ); ?></h4>
                        <p style="color: rgba(255,255,255,0.65); font-size: 0.85rem; margin-bottom: 1.25rem;"><?php esc_html_e( 'Наши эксперты готовы помочь Вам.', 'neksoz' ); ?></p>
