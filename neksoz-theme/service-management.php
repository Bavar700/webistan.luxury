    ...
    <section class="hero hero--internal">
        ...
        <div class="container hero__container" style="position:relative;z-index:2;">
            <div class="hero__content">
                <div class="hero__badge">Управленческий департамент</div>
                <h1 class="hero__title">
                    <span class="text-gradient">Управленческий</span><br>учет
                </h1>
                <p class="hero__desc">
                    Полная финансовая прозрачность и точные данные для принятия решений, которые реально увеличивают вашу прибыль.
                </p>
            </div>
            
            <div class="hero__actions--right">
                <a href="#lead-form" class="cta-crystal__btn" style="padding: 18px 50px; font-size: 13px;">
                    <span>Видеть реальную прибыль</span>
