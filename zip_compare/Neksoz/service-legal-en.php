<?php
/**
 * Template Name: Service: Legal (EN)
 */
get_header();
?>
...
<main class="site-main">
        ...
        <div class="container hero__container" style="position:relative;z-index:2;">
            <div class="hero__content">
                ...
                <h1 class="hero__title">
                    ...
                    <span class="text-gradient">solutions for business</span>
                </h1>
                <p class="hero__desc">
    ...
    <section class="section">
        <div class="container">
            <div class="section__header section__header--center" style="margin-bottom: 60px;">
                <div class="section__label">Legal Compliance</div>
                <h2 class="section__title">Your Shield in the Legal Field</h2>
                <p class="section__subtitle">We minimize risks where others only see difficulties.</p>
            </div>
            ...
            <div class="services-grid" style="grid-template-columns: repeat(2, 1fr); gap: 40px;">
                ...
                <div class="service-card" style="height: 100%;">
                    ...
                    <h3 class="service-card__title">When are consultations <br>needed?</h3></div>
                    <div class="service-card__tasks">
                        <ul class="service-card__list">
                            <li>Opening or re-registering a business</li>
                            <li>Complex real estate transactions</li>
                            <li>Protection of interests in legal disputes</li>
                            <li>Verification of contractors and contracts</li>
                            <li>Presence of hidden pitfalls in documents</li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="service-card" style="height: 100%;">
                    ...
                    <div class="service-card__tasks">
                        <ul class="service-card__list">
                            <li>Registration of legal entities</li>
                            <li>Support for real estate transactions</li>
                            <li>Representation in courts</li>
                            <li>Legal assistance and internal regulations</li>
                            <li>Analysis of commercial contracts</li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="service-card" style="height: 100%;">
                    ...
                    <div class="service-card__tasks">
                        <ul class="service-card__list">
                            <li>Legal analysis of the situation or document</li>
                            <li>Development of a strategy to protect interests</li>
                            <li>Preparation of lawsuits, complaints, and amendments</li>
                            <li>Representation in authorities and negotiations</li>
                            <li>Delivery of a ready-made solution or document</li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="service-card" style="height: 100%;">
                    ...
                    <div class="service-card__tasks">
                        <ul class="service-card__list">
                            <li>Minimization of legal risks in transactions</li>
                            <li>Legally registered assets and rights</li>
                            <li>Professional protection in the legal field</li>
                            <li>Reduction of administrative pressure</li>
                            <li>Confidence in every document</li>
                        </ul>
                    </div>
                </div>
    ...
    <section id="lead-form" class="section section--gray" style="border-top: 1px solid var(--nk-gray-100); padding-top: 40px; padding-bottom: 80px;">
        <div class="container" style="max-width: 800px;">
            <div class="section__header section__header--center" style="margin-bottom: 60px;">
                <div class="section__label">Legal Analysis</div>
                <h2 class="section__title">Free Express Assessment</h2>
                <p class="section__subtitle" style="margin-bottom: 0;">Leave a request for a preliminary legal assessment. We will contact you within 30 minutes.</p>
            </div>
                ...
                <form class="cta-crystal__form" action="#" method="POST" style="display: grid; gap: 24px;">
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 24px;">
                        ...
                        <div class="cta-crystal__field">
                            ...
                            <label for="lg-phone">Phone (+992)</label>
                        </div>
                    </div>
                    <div class="cta-crystal__field">
                        <input type="text" placeholder=" " id="lg-company">
                        <label for="lg-company">Company Name (Optional)</label>
                    </div>
                    <button type="submit" class="cta-crystal__btn"><span>Get Protection</span><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M5 12h14"/><path d="m12 5 7 7-7 7"/></svg></button>
