...
<main class="flex-grow bg-[#FDFBF7] min-h-screen">
	...
	<div class="relative pt-24 pb-20 sm:pt-32 sm:pb-24 overflow-hidden">
		...
		<div class="relative z-10 mx-auto max-w-4xl px-6 text-center">
			<span class="inline-block py-1.5 px-4 rounded-full bg-[#9A6735]/10 text-[#9A6735] text-xs font-bold tracking-[0.2em] uppercase mb-8" data-aos="fade-up">
				<?php echo tr('history_chronicle_label'); ?>
			</span>
			...
			<h1 class="text-5xl sm:text-6xl lg:text-7xl font-serif font-medium text-gray-900 leading-none mb-8" data-aos="fade-up" data-aos-delay="100">
				<?php echo tr('history_page_title'); ?>
			</h1>
			...
			<p class="text-xl text-gray-600 font-light leading-relaxed max-w-2xl mx-auto" data-aos="fade-up" data-aos-delay="200">
				<?php echo tr('history_intro_text'); ?>
			</p>
		</div>
	</div>
	...
	<div class="relative max-w-5xl mx-auto px-6 pb-32">
		...
		<div class="relative z-10 mb-20 md:mb-32 group" data-aos="fade-up">
			<div class="flex flex-col md:flex-row items-center">
				<div class="flex-1 w-full md:w-1/2 md:pr-12 md:text-right mb-8 md:mb-0">
					<span class="text-[#D4AF37] font-bold tracking-widest text-sm uppercase mb-2 block"><?php echo tr('history_era1_date'); ?></span>
					<h2 class="text-3xl font-serif text-gray-900 mb-4"><?php echo tr('history_era1_title'); ?></h2>
					<p class="text-gray-600 leading-relaxed">
						<?php echo tr('history_era1_desc'); ?>
					</p>
				</div>
				...
				<div class="flex-1 w-full md:w-1/2 md:pl-12">
					<div class="bg-white p-6 rounded-lg shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
						<p class="text-sm text-gray-500 italic mb-2"><?php echo tr('history_highlights'); ?>:</p>
						<ul class="space-y-2 text-gray-700 text-sm">
							<li class="flex items-start gap-2"><span class="text-[#D4AF37] mt-1">•</span> <?php echo tr('history_era1_pt1'); ?></li>
							<li class="flex items-start gap-2"><span class="text-[#D4AF37] mt-1">•</span> <?php echo tr('history_era1_pt2'); ?></li>
							<li class="flex items-start gap-2"><span class="text-[#D4AF37] mt-1">•</span> <?php echo tr('history_era1_pt3'); ?></li>
						</ul>
					</div>
				</div>
			</div>
		...
		<div class="relative z-10 mb-20 md:mb-32 group" data-aos="fade-up">
			<div class="flex flex-col md:flex-row-reverse items-center">
				<div class="flex-1 w-full md:w-1/2 md:pl-12 md:text-left mb-8 md:mb-0">
					<span class="text-[#9A6735] font-bold tracking-widest text-sm uppercase mb-2 block"><?php echo tr('history_era2_date'); ?></span>
					<h2 class="text-3xl font-serif text-gray-900 mb-4"><?php echo tr('history_era2_title'); ?></h2>
					<p class="text-gray-600 leading-relaxed">
						<?php echo tr('history_era2_desc'); ?>
					</p>
				</div>
				...
				<div class="flex-1 w-full md:w-1/2 md:pr-12 md:text-right">
					<div class="bg-white p-6 rounded-lg shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
						<p class="text-sm text-gray-500 italic mb-2"><?php echo tr('history_turning_point'); ?>:</p>
						<p class="text-gray-700 text-sm">
							<?php echo tr('history_era2_point'); ?>
						</p>
					</div>
				</div>
			</div>
		...
		<div class="relative z-10 mb-20 md:mb-32 group" data-aos="fade-up">
			<div class="flex flex-col md:flex-row items-center">
				<div class="flex-1 w-full md:w-1/2 md:pr-12 md:text-right mb-8 md:mb-0">
					<span class="text-[#9A6735] font-bold tracking-widest text-sm uppercase mb-2 block"><?php echo tr('history_era3_date'); ?></span>
					<h2 class="text-3xl font-serif text-gray-900 mb-4"><?php echo tr('history_era3_title'); ?></h2>
					<p class="text-gray-600 leading-relaxed">
						<?php echo tr('history_era3_desc'); ?>
					</p>
				</div>
				<div class="relative flex-shrink-0 w-12 h-12 bg-white border-4 border-[#9A6735] rounded-full z-10 flex items-center justify-center shadow-lg transform group-hover:scale-110 transition-transform duration-300">
					<div class="w-3 h-3 bg-[#9A6735] rounded-full"></div>
				...
				<div class="flex-1 w-full md:w-1/2 md:pl-12">
					<div class="bg-white p-6 rounded-lg shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
						<blockquote class="text-gray-600 italic border-l-2 border-gray-300 pl-4 text-sm">
							"<?php echo tr('history_era3_quote'); ?>"
						</blockquote>
					</div>
				</div>
			</div>
		...
		<div class="relative z-10 mb-20 md:mb-32 group" data-aos="fade-up">
			<div class="flex flex-col md:flex-row-reverse items-center">
				<div class="flex-1 w-full md:w-1/2 md:pl-12 md:text-left mb-8 md:mb-0">
					<span class="text-red-700 font-bold tracking-widest text-sm uppercase mb-2 block"><?php echo tr('history_era4_date'); ?></span>
					<h2 class="text-3xl font-serif text-gray-900 mb-4"><?php echo tr('history_era4_title'); ?></h2>
					<p class="text-gray-600 leading-relaxed">
						<?php echo tr('history_era4_desc'); ?>
					</p>
				</div>
				...
				<div class="flex-1 w-full md:w-1/2 md:pr-12 md:text-right">
					<div class="bg-red-50 p-6 rounded-lg border border-red-100 hover:shadow-md transition-shadow">
						<p class="text-sm text-red-800 font-bold mb-2"><?php echo tr('history_impact'); ?>:</p>
						<p class="text-gray-700 text-sm">
							<?php echo tr('history_era4_impact'); ?>
						</p>
					</div>
				</div>
			</div>
		...
		<div class="relative z-10 group" data-aos="fade-up">
			<div class="flex flex-col md:flex-row items-center">
				<div class="flex-1 w-full md:w-1/2 md:pr-12 md:text-right mb-8 md:mb-0">
					<span class="text-[#15803d] font-bold tracking-widest text-sm uppercase mb-2 block"><?php echo tr('history_era5_date'); ?></span>
					<h2 class="text-3xl font-serif text-gray-900 mb-4"><?php echo tr('history_era5_title'); ?></h2>
					<p class="text-gray-600 leading-relaxed">
						<?php echo tr('history_era5_desc'); ?>
					</p>
				</div>
				...
				<div class="flex-1 w-full md:w-1/2 md:pl-12">
					<div class="bg-white p-6 rounded-lg shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
						<p class="text-sm text-gray-500 italic mb-2"><?php echo tr('history_current_status'); ?>:</p>
						<p class="text-gray-700 text-sm">
							<?php echo tr('history_era5_status'); ?>
						</p>
					</div>
				</div>
			</div>
			...
			<div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
				...
				<div data-aos="fade-right">
					...
					<a href="<?php echo esc_url( home_url( '/ethnography/' ) ); ?>" class="group inline-flex items-center gap-3 px-8 py-4 bg-[#9A6735] text-white rounded-full hover:bg-[#8B5D30] transition-all duration-300 shadow-lg hover:shadow-xl hover:-translate-y-1">
						<span class="uppercase text-xs tracking-widest font-bold"><?php echo tr('history_cta_btn'); ?></span>
					...
					<div class="grid grid-cols-2 gap-6">
						<div class="space-y-6 transform translate-y-12">
							...
							<div class="p-6 bg-white rounded-2xl shadow-lg border border-gray-50">
								<p class="font-serif text-lg text-[#2F2F2F] italic">"<?php echo tr('history_era3_quote'); ?>"</p>
							</div>
						</div>
						<div class="space-y-6">
							 ...
							 <a href="<?php echo esc_url( home_url( '/gallery/' ) ); ?>" class="block w-full h-40 bg-[#2c3e50] rounded-2xl p-6 flex items-center justify-center relative overflow-hidden group cursor-pointer hover:shadow-lg transition-all">
								 ...
								 <span class="relative z-10 text-white font-serif text-xl"><?php echo tr('view_gallery'); ?></span>
							 </a>
						</div>
					</div>
				</div>
