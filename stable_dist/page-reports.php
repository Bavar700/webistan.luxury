	...
	<div class="py-16 sm:py-24">
		<div class="mx-auto max-w-4xl px-6">
			...
			<div class="prose prose-lg prose-headings:font-serif prose-headings:font-medium prose-p:font-light prose-a:text-primary hover:prose-a:text-gray-900 transition-colors mx-auto text-gray-600">
				<p><?php echo tr('reports_intro'); ?></p>
				
				<h3><?php echo tr('reports_early_title'); ?></h3>
				<p><?php echo tr('reports_early_content'); ?></p>

				<h3><?php echo tr('reports_ling_title'); ?></h3>
				<p><?php echo tr('reports_ling_content'); ?></p>

				<h3><?php echo tr('reports_anthro_title'); ?></h3>
				<p><?php echo tr('reports_anthro_content'); ?></p>

				<h3><?php echo tr('reports_env_title'); ?></h3>
				<p><?php echo tr('reports_env_content'); ?></p>
			</div>
