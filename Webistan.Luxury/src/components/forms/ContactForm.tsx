            ...
            <div className="container mx-auto px-6 relative z-10 max-w-7xl">
                ...
                <div className="mx-auto max-w-6xl space-y-12">
                    ...
                    >
                        ...
                        <div>
                            <h3 className="text-base md:text-2xl font-display font-medium tracking-[0.05em] md:tracking-[0.2em] uppercase leading-relaxed md:leading-tight group-hover:text-accent transition-colors duration-700">{t('initiation_title')}</h3>
