...
class Current_Role extends Base_Widget {

	public function get_name() {
		return 'ts-current-role';
	}

	public function get_title() {
		return __( 'Current role (VX)', 'voxel-elementor' );
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			...
			$this->add_control(
				'ts_role_ico',
				[
					'label' => __( 'Role icon', 'voxel-elementor' ),
            ...
            $this->add_control(
				'ts_switch_ico',
				[
					'label' => __( 'Switch icon', 'voxel-elementor' ),
					'type' => \Elementor\Controls_Manager::ICONS,
					'skin' => 'inline',
					'label_block' => false,
				]
		...
		$this->start_controls_section(
			...
			$this->start_controls_tabs( 'scnd_btn_tabs' );
	...
	protected function render( $instance = [] ) {
		...
		$can_switch = ! empty( $switchable_roles ) && ! $user->has_role( 'administrator' ) && ! $user->has_role( 'editor' );

		// wp_print_styles( $this->get_style_depends() );
		require locate_template( 'templates/widgets/current-role.php' );
	}
