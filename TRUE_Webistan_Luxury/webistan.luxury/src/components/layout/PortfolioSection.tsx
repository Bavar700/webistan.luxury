...
<span className="text-[11px] md:text-[13px] font-display font-medium tracking-[1em] text-foreground/90 uppercase block mb-6 -mr-[1em]"> {t('subheading')
}
</span>
...
<p className="font-sans text-base text-foreground/90 leading-relaxed font-light mt-8 max-w-sm "> {s.desc
}
</p>
</div>
</motion.div> ))
