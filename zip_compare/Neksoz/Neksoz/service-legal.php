...
<main class="site-main">
        ...
        <div class="container hero__container" style="position:relative;z-index:2;">
            <div class="hero__content">
                <h1 class="hero__title">
                    Комплексные<br>
                    <span class="text-gradient">юридические решения</span><br>
                    <span>бизнеса</span>
                </h1>
                <p class="hero__desc">
    ...
    <section class="section">
        <div class="container">
            <div class="section__header section__header--center" style="margin-bottom: 60px;">
                <div class="section__label">Правовой комплаенс</div>
                <h2 class="section__title">Ваш щит в правовом поле</h2>
                <p class="section__subtitle">Мы минимизируем риски там, где другие видят только сложности.</p>
            </div>
            ...
            <div class="services-grid" style="grid-template-columns: repeat(2, 1fr); gap: 40px;">
                ...
                <div class="service-card" style="height: 100%;">
                    ...
                    <h3 class="service-card__title">Когда нужны <br>консультации?</h3></div></div>
                    <div class="service-card__tasks">
                        <ul class="service-card__list">
                            <li>Открытие или перерегистрация бизнеса</li>
                            <li>Сложные сделки с недвижимостью</li>
                            <li>Защита интересов в судебных спорах</li>
                            <li>Проверка контрагентов и договоров</li>
                            <li>Наличие "подводных камней" в актах</li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="service-card" style="height: 100%;">
                    ...
                    <div class="service-card__tasks">
                        <ul class="service-card__list">
                            ...
                            <li>Представление в судебных инстанциях</li>
                            <li>Правовая помощь и внутренние положения</li>
                            <li>Анализ коммерческих договоров</li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="service-card" style="height: 100%;">
                    ...
                    <div class="service-card__tasks">
                        <ul class="service-card__list">
                            <li>Правовой анализ ситуации или документа</li>
                            <li>Разработка стратегии защиты интересов</li>
                            <li>Подготовка исков, жалоб и изменений</li>
                            <li>Представление в органах и переговорах</li>
                            <li>Передача готового решения или акта</li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="service-card" style="height: 100%;">
                    ...
                    <div class="service-card__tasks">
                        <ul class="service-card__list">
                            <li>Минимизация юридических рисков сделок</li>
                            <li>Законно оформленные активы и права</li>
                            <li>Профессиональная защита в правовом поле</li>
                            <li>Снижение административного давления</li>
                            <li>Уверенность в каждом документе</li>
                        </ul>
                    </div>
                </div>
    ...
    <section id="lead-form" class="section section--gray" style="border-top: 1px solid var(--nk-gray-100); padding-top: 40px; padding-bottom: 80px;">
        <div class="container" style="max-width: 800px;">
            <div class="section__header section__header--center" style="margin-bottom: 60px;">
                <div class="section__label">Правовой анализ</div>
                <h2 class="section__title">Бесплатная экспресс-оценка</h2>
                <p class="section__subtitle" style="margin-bottom: 0;">Оставьте заявку на предварительную юридическую оценку. Мы свяжемся с вами в течение 30 минут.</p>
            </div>
                ...
                <form class="cta-crystal__form" action="#" method="POST" style="display: grid; gap: 24px;">
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 24px;">
                        <div class="cta-crystal__field">
                            ...
                            <label for="sl-name">Ваше имя</label>
                        </div>
                        <div class="cta-crystal__field">
                    ...
                    <div class="cta-crystal__field">
                        ...
                        <label for="sl-company">Название компании (опционально)</label>
                    </div>
                    <button type="submit" class="cta-crystal__btn"><span>Получить защиту</span><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M5 12h14"/><path d="m12 5 7 7-7 7"/></svg></button>
