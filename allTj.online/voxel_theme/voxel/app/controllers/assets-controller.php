...
class Assets_Controller extends Base_Controller {
	...
	protected $deferred_scripts = [
		...
		'mapbox-gl' => true,
		'leaflet' => true,
		'leaflet-fullscreen' => true,
		'leaflet-gesture-handling' => true,
		'pikaday' => true,
		'nouislider' => true,
		'vx:commons.js' => true,
	...
	protected function register_scripts() {
		...
		wp_register_script( 'leaflet-fullscreen', $vendor.'leaflet-fullscreen/Control.FullScreen.js', ['leaflet'], '5.3.1', true );
		wp_register_style( 'leaflet-fullscreen', $vendor.'leaflet-fullscreen/Control.FullScreen.css', ['leaflet'], '5.3.1' );
		wp_register_script( 'leaflet-gesture-handling', $vendor.'leaflet-gesture-handling/leaflet-gesture-handling.min.js', ['leaflet'], '1.4.4', true );
		wp_register_style( 'leaflet-gesture-handling', $vendor.'leaflet-gesture-handling/leaflet-gesture-handling.min.css', ['leaflet'], '1.4.4' );
	...
	protected function print_head_content() {
		$config = [
			...
			'l10n' => [
				...
				'gestureTouch' => __( 'Use two fingers to move the map', 'voxel' ),
				'gestureScroll' => __( 'Use ctrl + scroll to zoom the map', 'voxel' ),
				'gestureScrollMac' => __( "Use \u{2318} + scroll to zoom the map", 'voxel' ),
