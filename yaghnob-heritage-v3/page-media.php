	...
	<div class="py-16 sm:py-24">
		<div class="mx-auto max-w-4xl px-6">
			...
			<div class="prose prose-lg prose-headings:font-serif prose-headings:font-medium prose-p:font-light prose-a:text-primary hover:prose-a:text-gray-900 transition-colors mx-auto text-gray-600">
				<p><?php echo tr('media_intro'); ?></p>
				
				<h3><?php echo tr('media_docs_title'); ?></h3>
				<p><?php echo tr('media_docs_content'); ?></p>

				<h3><?php echo tr('media_oral_title'); ?></h3>
				<p><?php echo tr('media_oral_content'); ?></p>

				<h3><?php echo tr('media_music_title'); ?></h3>
				<p><?php echo tr('media_music_content'); ?></p>

				<h3><?php echo tr('media_lang_title'); ?></h3>
				<p><?php echo tr('media_lang_content'); ?></p>
			</div>
