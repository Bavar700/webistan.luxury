...
<div className="w-10 h-10 relative flex items-center justify-center text-foreground/85 group-hover:text-accent group-hover:bg-accent/[0.03] transition-all duration-1000">
...
<p className="font-sans text-base text-foreground/90 leading-relaxed font-light mt-8 max-w-sm "> {t(`items.${s.key}.desc`)
}
</p>
</div>
</motion.div> ))
