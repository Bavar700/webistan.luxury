...
<footer class="footer-platinum">
    ...
    <div class="container" style="position:relative; z-index:10;">
        <div class="footer-minimal">
            ...
            <nav class="footer-minimal__nav footer-nav--icons fade-up">
                <a href="<?php echo nk_link('/?lang=en', 'en'); ?>">
                ...
                <a href="<?php echo nk_link('/services', 'en'); ?>">
                    ...
                    <?php _e('Services', 'neksoz'); ?>
                </a>
                <a href="<?php echo nk_link('/team', 'en'); ?>">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>
                    Team
                </a>
                <a href="<?php echo nk_link('/news', 'en'); ?>">
                ...
                <a href="<?php echo nk_link('/contacts', 'en'); ?>">
            ...
            <?php 
            $current_lang = (function_exists('nk_get_current_lang')) ? nk_get_current_lang() : 'en';
            $qr_labels = [
            ...
            $current_labels = isset($qr_labels[$current_lang]) ? $qr_labels[$current_lang] : $qr_labels['en'];
            ?>
            ...
            <div class="footer-platinum__social-hub fade-up" style="margin: 40px 0 0 0;">
                <div class="footer-platinum__socials">
                    ...
                    <a href="tel:+992446000000" class="footer-platinum__social-btn" title="Call">
    ...
    <div class="container" style="position:relative; z-index:10;">
        <div class="footer-platinum__bottom">
            <p>&copy; <?php echo date('Y'); ?> NEKSOZ. <?php if(function_exists('pll_e')) pll_e('All rights reserved.'); else _e('All rights reserved.', 'neksoz'); ?></p>
            ...
            <div class="footer-platinum__legal">
                <a href="<?php echo nk_link('/privacy-policy', 'en'); ?>"><?php _e('Privacy Policy', 'neksoz'); ?></a>
                <a href="<?php echo nk_link('/terms', 'en'); ?>"><?php _e('Terms of Service', 'neksoz'); ?></a>
            </div>
        </div>
    </div>
</footer>
    ...
    <div class="map-modal__container">
        ...
        <div class="map-modal__content">
            ...
            <div class="map-modal__card">
                ...
                <span>Tajikistan, Dushanbe, 42 Rudaki Ave</span>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="modal__content" style="padding: 0;">
            <div class="cta-crystal__grid">
                ...
                <div class="cta-crystal__content">
                    <h3 class="cta-crystal__title"><span class="text-gradient">Ready to Scale</span><br>Your Success?</h3>
                    <p class="cta-crystal__text">Submit a request today, and we will develop a personalized strategy for the growth of your business.</p>
                </div>
                ...
                <div class="cta-crystal__form-wrapper">
                    <form action="#" class="cta-crystal__form">
                        <div class="cta-crystal__field">
                            ...
                            <label for="m-f-name">Your Name</label>
                        </div>
                        <div class="cta-crystal__field">
                            <input type="tel" placeholder=" " required id="m-f-phone">
                            <label for="m-f-phone">Phone (+992)</label>
                        </div>
                        <div class="cta-crystal__field nx-dropdown" id="modalDropdown">
                            ...
                            <label for="m-f-service-input">Select Service Direction <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" style="margin-left: 4px; display: inline-block; vertical-align: middle;"><path d="m6 9 6 6 6-6"/></svg></label>
                            <div class="nx-dropdown__panel">
                                <div class="nx-dropdown__option" data-val="legal">Legal Support</div>
                                <div class="nx-dropdown__option" data-val="tax">Tax Consulting</div>
                                <div class="nx-dropdown__option" data-val="audit">Audit & Accounting</div>
                                <div class="nx-dropdown__option" data-val="accounting">Accounting</div>
                        ...
                        <div class="cta-crystal__field">
                            ...
                            <label for="m-f-msg">Details of your request</label>
                        </div>
