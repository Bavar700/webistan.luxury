        ...
        <div class="container hero__container" style="position:relative;z-index:2;">
            <div class="hero__content">
                ...
                <h1 class="hero__title">
                    <span style="white-space: nowrap;">Professional secretarial</span><br>
                    <span class="text-gradient" style="white-space: nowrap;">services for business</span>
                </h1>
                <p class="hero__desc">
    ...
    <section class="section">
        <div class="container">
            <div class="section__header section__header--center" style="margin-bottom: 60px;">
                <div class="section__label">Migration Compliance</div>
                <h2 class="section__title">Legality and Staff Mobility</h2>
                <p class="section__subtitle">We handle all the bureaucracy so your specialists can work without unnecessary pauses.</p>
            </div>
            ...
            <div class="services-grid" style="grid-template-columns: repeat(2, 1fr); gap: 40px;">
                ...
                <div class="service-card" style="height: 100%;">
                    ...
                    <h3 class="service-card__title">When is support <br>needed?</h3></div>
                    <div class="service-card__tasks">
                        <ul class="service-card__list">
                            <li>Attracting foreign specialists</li>
                            <li>Obtaining work visas (type M)</li>
                            <li>Extending registration in OVIR</li>
                            <li>Working with Dipservice (type K)</li>
                            <li>Need for legal document translation</li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="service-card" style="height: 100%;">
                    ...
                    <div class="service-card__tasks">
                        <ul class="service-card__list">
                            <li>Licenses for attracting citizens</li>
                            <li>Preparation of invitations and permits</li>
                            <li>Visa extension (types M, K, O-2)</li>
                            <li>Obtaining Dipservice cards</li>
                            <li>Professional document translation</li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="service-card" style="height: 100%;">
                    ...
                    <div class="service-card__tasks">
                        <ul class="service-card__list">
                            <li>Determining the visa type and list</li>
                            <li>Checking documents for legal compliance</li>
                            <li>Submitting documents to state authorities</li>
                            <li>Interaction with the migration service</li>
                            <li>Delivering ready permits to the client</li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="service-card" style="height: 100%;">
                    ...
                    <div class="service-card__tasks">
                        <ul class="service-card__list">
                            <li>Legal status of all foreign specialists</li>
                            <li>No problems with legislation</li>
                            <li>Reducing the workload on management</li>
                            <li>Fast processing times for permits</li>
                            <li>Correctly translated documentation</li>
                        </ul>
                    </div>
                </div>
    ...
    <section id="lead-form" class="section section--gray" style="border-top: 1px solid var(--nk-gray-100); padding-top: 40px; padding-bottom: 80px;">
        <div class="container" style="max-width: 800px;">
            <div class="section__header section__header--center" style="margin-bottom: 60px;">
                ...
                <h2 class="section__title">Free Consultation</h2>
                <p class="section__subtitle" style="margin-bottom: 0;">Leave a request for a preliminary migration assessment.<br>We will contact you within 30 minutes.</p>
            </div>
                ...
                <form class="cta-crystal__form" action="#" method="POST" style="display: grid; gap: 24px;">
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 24px;">
                        ...
                        <div class="cta-crystal__field">
                            ...
                            <label for="ss-phone">Phone (+992)</label>
                        </div>
                    </div>
                    <div class="cta-crystal__field">
                        <input type="text" placeholder=" " id="ss-company">
                        <label for="ss-company">Company Name (Optional)</label>
                    </div>
                    <button type="submit" class="cta-crystal__btn"><span>Get a Visa</span><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M5 12h14"/><path d="m12 5 7 7-7 7"/></svg></button>
