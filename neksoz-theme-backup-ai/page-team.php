...
if (function_exists('nk_get_current_lang')) {
 ...
 echo get_template_directory_uri(); ?>/assets/images/team/team-3.jpg" alt="Салимов Зоир Муминович" class="expert-card__img">
                    </div>
...
if (function_exists('nk_get_current_lang')) {
 ...
 echo get_template_directory_uri(); ?>/assets/images/team/team-1.jpg" alt="Фатхуддинзода Диловар Каромат" class="expert-card__img expert-card__img--top">
                    </div>
                    <div class="expert-card__body">
...
if (function_exists('nk_get_current_lang')) {
 ...
 echo get_template_directory_uri(); ?>/assets/images/team/team-2.jpg" alt="Ширинов Рустам Сухробович" class="expert-card__img">
                    </div>
                    <div class="expert-card__body">
...
if (function_exists('nk_get_current_lang')) {
 ...
 echo get_template_directory_uri(); ?>/assets/images/team/team-5.jpg" alt="Курбонов Шохрух Камолуддинович" class="expert-card__img">
                    </div>
                    <div class="expert-card__body">
                        <div class="expert-card__role">Ведущий бухгалтер</div>
...
if (function_exists('nk_get_current_lang')) {
 ...
 echo get_template_directory_uri(); ?>/assets/images/team/team-4.jpg" alt="Ливенгуд Джастин Рег" class="expert-card__img">
                    </div>
                    <div class="expert-card__body">
...
if (function_exists('nk_get_current_lang')) {
 ...
 echo home_url('/vacancies'); ?>" class="btn btn--primary" style="width: 100%;">
