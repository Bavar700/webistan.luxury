...
<svg viewBox="0 0 36 18" fill="none" xmlns="http://www.w3.org/2000/svg" className="overflow-visible w-full h-full" shapeRendering="geometricPrecision" >
{/* Base Animated Path */}
<motion.path d={pathD}
stroke="#B8860B" strokeWidth="3.6" strokeLinecap="round" strokeLinejoin="round" strokeDasharray={`${pathLength * 0.85} ${pathLength * 0.15}`}
animate={{
...
{/* Bright Leading Edge */}
<motion.path d={pathD}
stroke="#FFF" strokeWidth="3.6" strokeLinecap="round" strokeDasharray={`1 ${pathLength - 1}`} initial={{
