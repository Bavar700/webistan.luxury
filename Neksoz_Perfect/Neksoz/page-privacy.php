 ...
 * Description: Standard Privacy Policy and Terms of Use page for Neksoz.
 */
if (function_exists('nk_get_current_lang') && nk_get_current_lang() === 'tj') {
    get_template_part('page', 'privacy-tj');
    return;
}
if (function_exists('nk_get_current_lang') && nk_get_current_lang() === 'en') {
    get_template_part('page', 'privacy-en');
    return;
}
get_header(); ?>
            ...
            <div class="service-card" style="padding: 60px; max-width: 960px; margin: 0 auto; min-height: auto; cursor: default; transform: none; box-shadow: 0 40px 100px rgba(0, 13, 51, 0.05);">
                ...
                <article class="legal-block" style="margin-bottom: 80px;">
                    ...
                    <p style="font-size: 16px; line-height: 1.8; color: var(--nk-gray-800); margin-bottom: 40px;">
                        ООО «НЕКСОЗ-БИЗНЕС КОНСАЛТИНГ ГРУП» (далее — «Компания») уделяет большое внимание защите ваших персональных данных. Настоящая Политика объясняет, как мы собираем, используем и защищаем информацию, которую вы предоставляете при использовании нашего сайта.
                    </p>
                    ...
                    <div style="display: grid; gap: 40px;">
                        ...
                        <div class="legal-section">
                            ...
                            <p style="color: var(--nk-gray-600); line-height: 1.7;">Ваша информация используется исключительно для оказания профессиональных услуг (аудит, учет, консалтинг), улучшения качества обслуживания и соблюдения требований законодательства Республики Таджикистан.</p>
                        </div>

                        <div class="legal-section">
                            <h3 style="font-size: 18px; margin-bottom: 16px; color: var(--nk-gray-900);">3. Защита данных и конфиденциальность</h3>
                            <p style="color: var(--nk-gray-600); line-height: 1.7;">Мы применяем современные технические и организационные меры безопасности. Доступ к персональной информации имеют только сотрудники, непосредственно участвующие в оказании услуги, и все они связаны обязательствами о неразглашении (NDA).</p>
                        </div>

                        <div class="legal-section">
                            <h3 style="font-size: 18px; margin-bottom: 16px; color: var(--nk-gray-900);">4. Передача третьим лицам</h3>
                            <p style="color: var(--nk-gray-600); line-height: 1.7;">Мы не продаем и не передаем ваши данные третьим лицам в маркетинговых целях. Раскрытие информации возможно только в случаях, предусмотренных законом.</p>
                        </div>
                ...
                <article class="legal-block">
                    ...
                    <div style="display: grid; gap: 40px;">
                        <div class="legal-section">
                            ...
                            <p style="color: var(--nk-gray-600); line-height: 1.7;">Содержимое этого сайта носит информационный характер. Информация о наших услугах не является публичной офертой, а служит для ознакомления с компетенциями Компании.</p>
                        </div>

                        <div class="legal-section">
                            <h3 style="font-size: 18px; margin-bottom: 16px; color: var(--nk-gray-900);">2. Использование материалов сайта</h3>
                            <p style="color: var(--nk-gray-600); line-height: 1.7;">Весь контент является интеллектуальной собственностью ООО «НЕКСОЗ-БИЗНЕС КОНСАЛТИНГ ГРУП». Любое копирование допускается только с письменного согласия или с указанием активной ссылки на первоисточник.</p>
                        </div>
                        ...
                        <div class="legal-section">
                            ...
                            <p style="color: var(--nk-gray-600); line-height: 1.7;">Все детали взаимодействия при сотрудничестве регулируются отдельным Договором об оказании услуг со строгими пунктами о конфиденциальности.</p>
                        </div>

                        <div class="legal-section">
                            <h3 style="font-size: 18px; margin-bottom: 16px; color: var(--nk-gray-900);">5. Изменение условий</h3>
                            <p style="color: var(--nk-gray-600); line-height: 1.7;">Компания оставляет за собой право обновлять настоящие Условия. Актуальная версия всегда доступна на этой странице.</p>
                        </div>
                    </div>
                </article>
