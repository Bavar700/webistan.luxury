        ...
        <div class="container">
            <div class="services-grid">
                ...
                <div class="service-card fade-up">
                    ...
                    <h3 class="service-card__title">Аудит финансовой деятельности</h3></div></div>
                ...
                <div class="service-card fade-up fade-up-delay-1">
                    ...
                    <h3 class="service-card__title">Восстановление финансового учета</h3></div></div>
                ...
                <div class="service-card fade-up fade-up-delay-2">
                    ...
                    <h3 class="service-card__title">Юридические консультации</h3></div></div>
                ...
                <div class="service-card fade-up">
                    ...
                    <h3 class="service-card__title">Ведение финансового и кадрового учета</h3></div></div>
                ...
                <div class="service-card fade-up fade-up-delay-1">
                    ...
                    <h3 class="service-card__title">Услуги секретариата</h3></div></div>
                ...
                <div class="service-card fade-up fade-up-delay-2">
                    ...
                    <h3 class="service-card__title">Бизнес-консультации</h3></div></div>
                ...
                <div class="service-card fade-up">
                    ...
                    <h3 class="service-card__title">Налоговые консультации</h3></div></div>
                ...
                <div class="service-card fade-up fade-up-delay-1">
                    ...
                    <h3 class="service-card__title">Управленческий учет</h3></div></div>
                ...
                <div class="service-card fade-up fade-up-delay-2">
                    ...
                    <h3 class="service-card__title">Автоматизация бизнес-процессов</h3></div></div>
