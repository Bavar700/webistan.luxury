                    ...
                    >
                        ...
                        >
                            ...
                            <div className="relative z-10 space-y-2">
                                <span className="text-[9px] uppercase tracking-[0.5em] text-accent font-bold block animate-pulse">
                                    {t('foundational_partner_protocol')}
                                </span>
                                <p className="text-[10px] md:text-[14px] uppercase tracking-[0.2em] text-[#E5D5B0] font-light leading-relaxed italic text-balance">
                                    {t.rich('discount_text', {
                                        discount: (chunks) => <span className="font-bold text-accent">{chunks}</span>
                                    })}
                                </p>
                            </div>
                        </motion.div>
                    ...
                    <div className="pt-24 border-t-[0.5px] border-accent/10 flex flex-col items-center gap-20">
                        <div className="text-center space-y-8">
                            <div className="flex flex-col items-center">
                                ...
                                <div className="text-5xl md:text-9xl font-display font-extralight text-[#E5D5B0] tracking-tighter flex items-center justify-center gap-4">
                                    {totalPrice.toLocaleString()} <span className="text-2xl md:text-6xl text-[#E5D5B0]/30">TJS</span>
                                </div>
                            </div>
