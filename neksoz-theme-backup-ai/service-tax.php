    ...
    <section class="section">
        <div class="container">
            <div class="section__header section__header--center" style="margin-bottom: 60px;">
                ...
                <p class="section__subtitle">Мы помогаем платить налоги правильно, исключая переплаты и защищая от претензий ФНС.</p>
            </div>
                ...
                <div class="service-card" style="height: 100%;">
                    ...
                    <div class="service-card__tasks">
                        <ul class="service-card__list">
                            ...
                            <li>Уверенность в каждом тенге отчислений</li>
                            <li>Отсутствие блокировок и претензий ФНС</li>
