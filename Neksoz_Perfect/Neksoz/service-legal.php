<?php
/**
 * Template Name: Service: Legal (RU)
 */
get_header();
?>
...
<main class="site-main">
        ...
        <div class="container hero__container" style="position:relative;z-index:2;">
            <div class="hero__content">
                ...
                <h1 class="hero__title">
                    <span style="white-space: nowrap;">Комплексные юридические</span><br>
                    <span class="text-gradient" style="white-space: nowrap;">решения для бизнеса</span>
                </h1>
                <p class="hero__desc">
    ...
    <section class="section">
        <div class="container">
            <div class="section__header section__header--center" style="margin-bottom: 60px;">
                <div class="section__label">Правовое соответствие</div>
                <h2 class="section__title">Ваш щит в правовом поле</h2>
                <p class="section__subtitle">Мы минимизируем риски там, где другие видят только проблемы.</p>
            </div>
            ...
            <div class="services-grid" style="grid-template-columns: repeat(2, 1fr); gap: 40px;">
                ...
                <div class="service-card" style="height: 100%;">
                    ...
                    <h3 class="service-card__title">Когда нужны <br>консультации?</h3></div>
                    <div class="service-card__tasks">
                        <ul class="service-card__list">
                            <li>Открытие или перерегистрация бизнеса</li>
                            <li>Настройка трудовых отношений с персоналом</li>
                            <li>Правовая экспертиза договоров (Аудит)</li>
                            <li>Разрешение споров с надзорными органами</li>
                ...
                <div class="service-card" style="height: 100%;">
                    ...
                    <div class="service-card__tasks">
                        <ul class="service-card__list">
                            <li>Разработка любых юридических договоров</li>
                            <li>Юридическое сопровождение сделок</li>
                            <li>Представительство в переговорах</li>
                            <li>Сопровождение процесса лицензирования</li>
                            <li>Абонентское обслуживание (Аутсорс)</li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="service-card" style="height: 100%;">
                    ...
                    <div class="service-card__tasks">
                        <ul class="service-card__list">
                            <li>Анализ ситуации и потенциальных рисков</li>
                            <li>Поиск оптимальных правовых решений</li>
                            <li>Подготовка пакета необходимых документов</li>
                            <li>Сопровождение до финального результата</li>
                            <li>Консультации по предотвращению проблем</li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="service-card" style="height: 100%;">
                    ...
                    <div class="service-card__tasks">
                        <ul class="service-card__list">
                            <li>Полная юридическая безопасность бизнеса</li>
                            <li>Предотвращение финансовых потерь в сделках</li>
                            <li>Оперативное решение спорных вопросов</li>
                            <li>Соответствие законодательству РТ</li>
                            <li>Спокойствие и фокус на развитии бизнеса</li>
                        </ul>
                    </div>
                </div>
    ...
    <section id="lead-form" class="section section--gray" style="border-top: 1px solid var(--nk-gray-100); padding-top: 40px; padding-bottom: 80px;">
        <div class="container" style="max-width: 800px;">
            <div class="section__header section__header--center" style="margin-bottom: 60px;">
                <div class="section__label">Юридическая экспертиза</div>
                <h2 class="section__title">Бесплатная первичная консультация</h2>
                ...
                <form class="cta-crystal__form" action="#" method="POST" style="display: grid; gap: 24px;">
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 24px;">
                        <div class="cta-crystal__field">
                            ...
                            <label for="lg-name">Ваше имя</label>
                        </div>
                        <div class="cta-crystal__field">
                    ...
                    <div class="cta-crystal__field">
                        ...
                        <label for="lg-company">Название компании (опционально)</label>
                    </div>
                    <button type="submit" class="cta-crystal__btn"><span>Защитить бизнес</span><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M5 12h14"/><path d="m12 5 7 7-7 7"/></svg></button>
