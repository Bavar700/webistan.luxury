            ...
            <div style="display: grid; grid-template-columns: 1fr 340px; gap: 4rem; align-items: start;">
                ...
                <article class="nk-content page-content fade-up is-visible">
                    <div style="background: var(--nk-bg-alt); padding: 3rem; border-radius: 12px; text-align: center; border: 1px solid var(--nk-border);">
                        ...
                        <p style="font-size: 1.1rem; color: var(--nk-text-secondary); line-height: 1.6; margin: 0 auto; max-width: 500px;">ÐœÑ‹ Ð¿Ð¾Ð¼Ð¾Ð¶ÐµÐ¼ Ð¿Ñ€Ð¸Ð²ÐµÑÑ‚Ð¸ Ð²Ð°ÑˆÑƒ Ð±ÑƒÑ…Ð³Ð°Ð»Ñ‚ÐµÑ€ÑÐºÑƒÑŽ Ð±Ð°Ð·Ñƒ Ð¸ Ð´Ð¾ÐºÑƒÐ¼ÐµÐ½Ñ‚Ð°Ñ†Ð¸ÑŽ Ð² Ð¿Ð¾Ð»Ð½Ð¾Ðµ ÑÐ¾Ð¾Ñ‚Ð²ÐµÑ‚ÑÑ‚Ð²Ð¸Ðµ Ñ Ð·Ð°ÐºÐ¾Ð½Ð¾Ð´Ð°Ñ‚ÐµÐ»ÑŒÑÑ‚Ð²Ð¾Ð¼ Ð¸ Ð¿Ð¾Ð´Ð³Ð¾Ñ‚Ð¾Ð²Ð¸Ð¼ Ð²ÑÑ‘ Ð½ÐµÐ¾Ð±Ñ…Ð¾Ð´Ð¸Ð¼Ð¾Ðµ Ð´Ð»Ñ ÑƒÑÐ¿ÐµÑˆÐ½Ð¾Ð³Ð¾ Ð¿Ñ€Ð¾Ñ…Ð¾Ð¶Ð´ÐµÐ½Ð¸Ñ Ð¿Ñ€Ð¾Ð²ÐµÑ€Ð¾Ðº.</p>
                    </div>
                </article>
