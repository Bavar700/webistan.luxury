                        ...
                        <div className="text-center space-y-8">
                            ...
                            {projectType !== 'Landing' ? (
                                <div className="flex flex-col items-center gap-2">
                                    ...
                                    <span className="text-3xl md:text-6xl font-display text-accent tracking-[0.05em] md:tracking-[0.2em]">{totalPrice.toLocaleString()} TJS</span>
                    ...
                    <div className="fixed inset-0 z-[100] flex justify-end">
                        ...
                        >
                            <div className="sticky top-0 bg-background backdrop-blur-md z-10 px-6 md:px-8 py-5 md:py-6 border-b-[0.5px] border-accent/10 flex items-center justify-between gap-4">
                                <h3 className="text-[11px] md:text-[13px] uppercase tracking-[0.3em] text-accent font-black truncate">
                                    {t('details_drawer_title')}
                                </h3>
                                <button
                                    onClick={() => setIsDrawerOpen(false)}
                                    className="flex-shrink-0 text-foreground/40 hover:text-accent transition-colors flex items-center gap-2"
                                >
                            ...
                            <div className="p-6 md:p-8 space-y-10">
                                <div className="space-y-4">
                                    <h4 className="text-[14px] md:text-[18px] font-display text-foreground tracking-[0.1em] uppercase border-l-2 border-accent pl-4">
                                        {t('drawer_content.title')}
                                    </h4>
                                    <p className="text-[12px] text-foreground/70 leading-relaxed font-light">
                                        {t('drawer_content.intro')}
                                    </p>
                                </div>
                                ...
                                <div className="space-y-6">
                                    ...
                                    <ul className="space-y-4">
                                        <li
                                            className="text-[12px] text-foreground/80 leading-relaxed pl-4 border-l border-white/5"
                                            dangerouslySetInnerHTML={{ __html: t.raw('drawer_content.base_works.dev') }}
                                        />
                                        <li
                                            className="text-[12px] text-foreground/80 leading-relaxed pl-4 border-l border-white/5"
                                            dangerouslySetInnerHTML={{ __html: t.raw('drawer_content.base_works.lang') }}
                                        />
                                    </ul>
                                </div>
                                ...
                                <div className="space-y-6">
                                    ...
                                    <ul className="space-y-5">
                                        {['localpay', 'ads', 'infrastructure', 'ai', 'seo', 'narrative', 'branding'].map((module) => (
                                            <li
                                                key={module}
                                                className="text-[12px] text-foreground/80 leading-relaxed pl-4 border-l border-white/5 hover:border-accent/30 transition-colors"
                                                dangerouslySetInnerHTML={{ __html: t.raw(`drawer_content.modules.${module}`) }}
                                            />
                                        ))}
                                    </ul>
                                </div>
                                ...
                                <div className="mt-12 p-6 bg-accent/[0.03] border-[0.5px] border-accent/20 rounded-sm">
                                    ...
                                    <p className="text-[11px] text-foreground/70 leading-relaxed font-light italic">
                                        {t('drawer_content.note_text')}
                                    </p>
                                </div>
                            </div>
                        </motion.div>
