<?php
/**
 * Template Name: Service: Accounting (EN)
 */
get_header();
?>
...
<main class="site-main">
        ...
        <div class="container hero__container" style="position:relative;z-index:2;">
            <div class="hero__content">
                ...
                <h1 class="hero__title">
                    <span style="white-space: nowrap;">Financial and HR</span><br>
                    <span class="text-gradient" style="white-space: nowrap;">accounting management</span>
                </h1>
                <p class="hero__desc">
    ...
    <section class="section">
        <div class="container">
            <div class="section__header section__header--center" style="margin-bottom: 60px;">
                <div class="section__label">Financial Transparency</div>
                <h2 class="section__title">Professional Accounting for Your Growth</h2>
                <p class="section__subtitle">We don't just prepare reports; we guarantee the financial security of your business.</p>
            </div>
            ...
            <div class="services-grid" style="grid-template-columns: repeat(2, 1fr); gap: 40px;">
                ...
                <div class="service-card" style="height: 100%;">
                    ...
                    <h3 class="service-card__title">When is outsourcing <br>needed?</h3></div>
                    <div class="service-card__tasks">
                        <ul class="service-card__list">
                            <li>High costs of maintaining an in-house accounting team</li>
                            <li>Reporting errors and fines from government agencies</li>
                            <li>Difficulty in tracking changes in legislation</li>
                            <li>Difficulties in finding qualified personnel</li>
                            <li>Desire to focus on the core business</li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="service-card" style="height: 100%;">
                    ...
                    <div class="service-card__tasks">
                        <ul class="service-card__list">
                            <li>Full maintenance of accounting and tax records</li>
                            <li>Preparation and submission of reports (tax, statistical)</li>
                            <li>HR administration and payroll calculation</li>
                            <li>Preparation of documents for audits and banks</li>
                            <li>Consultations on accounting optimization</li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="service-card" style="height: 100%;">
                    ...
                    <div class="service-card__tasks">
                        <ul class="service-card__list">
                            <li>Receipt and systematization of primary documents</li>
                            <li>Data entry into specialized software (1C)</li>
                            <li>Calculation of taxes and mandatory payments</li>
                            <li>Control of reporting deadlines</li>
                ...
                <div class="service-card" style="height: 100%;">
                    ...
                    <div class="service-card__tasks">
                        <ul class="service-card__list">
                            <li>Reduction of accounting costs by up to 50%</li>
                            <li>Absence of tax risks and fines</li>
                            <li>Transparent picture of financial condition</li>
                            <li>Expert support on all issues</li>
                            <li>Readiness for any regulatory audits</li>
                        </ul>
                    </div>
                </div>
    ...
    <section id="lead-form" class="section section--gray" style="border-top: 1px solid var(--nk-gray-100); padding-top: 40px; padding-bottom: 80px;">
        <div class="container" style="max-width: 800px;">
            <div class="section__header section__header--center" style="margin-bottom: 60px;">
                <div class="section__label">Accounting Audit</div>
            ...
            <div class="cta-crystal__form-box" style="background: var(--nk-white); padding: 60px; border-radius: 32px; box-shadow: 0 40px 100px rgba(0, 13, 51, 0.08); border: 1px solid var(--nk-gray-50);">
                <form class="cta-crystal__form" action="#" method="POST" style="display: grid; gap: 24px;">
                    ...
                    <button type="submit" class="cta-crystal__btn"><span>Request an Audit</span><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M5 12h14"/><path d="m12 5 7 7-7 7"/></svg></button>
