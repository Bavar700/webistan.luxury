<?php
/**
 * Template Name: Service: Restore (EN)
 */
get_header();
?>
...
<main class="site-main">
    ...
    <section class="section">
        <div class="container">
            ...
            <div class="section__header section__header--center" style="margin-bottom: 60px;">
                <div class="section__label">Condition analysis</div>
                <h2 class="section__title">Comprehensive approach to restoration</h2>
                <p class="section__subtitle">We don't just fix errors; we build a reliable financial system from scratch.</p>
            </div>
            ...
            <div class="services-grid" style="grid-template-columns: repeat(2, 1fr); gap: 40px;">
                ...
                <div class="service-card" style="height: 100%;">
                    ...
                    <h3 class="service-card__title">When is this <br>service needed?</h3></div>
                    <div class="service-card__tasks">
                        <ul class="service-card__list">
                            <li>Accountant changed, affairs not handed over</li>
                            <li>Loss of primary documents or 1C databases</li>
                            <li>Tax audit is approaching</li>
                            <li>Accounts are blocked by state bodies</li>
                            <li>Accounting has not been kept for more than 3 months</li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="service-card" style="height: 100%;">
                    ...
                    <h3 class="service-card__title">Process <br>details</h3></div>
                    <div class="service-card__tasks">
                        <ul class="service-card__list">
                            <li><strong>Primary audit:</strong> assessment of the scale of problems</li>
                            <li><strong>Data collection:</strong> requests to banks and counterparties</li>
                            <li><strong>Entry into database:</strong> restoration of all periods</li>
                            <li><strong>Reconciliation with authorities:</strong> elimination of all discrepancies</li>
                            <li><strong>Removal of arrest:</strong> unblocking of your accounts</li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="service-card" style="height: 100%;">
                    ...
                    <h3 class="service-card__title">Step-by-step <br>cooperation plan</h3></div>
                    <div class="service-card__tasks">
                        <ul class="service-card__list">
                            <li>Signing the contract and NDA</li>
                            <li>Free express assessment of the volume</li>
                            <li>Active data restoration phase</li>
                            <li>Protection of results before state bodies</li>
                            <li>Handover of a clean 1C database and recommendations</li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="service-card" style="height: 100%;">
                    ...
                    <h3 class="service-card__title">Result for <br>your business</h3></div>
                    <div class="service-card__tasks">
                        <ul class="service-card__list">
                            <li><strong>Full legality:</strong> according to RT laws</li>
                            <li><strong>Zero risks:</strong> absence of penalties and fines</li>
                            <li><strong>Transparency:</strong> you see the real profit</li>
                            <li><strong>Security:</strong> protection from audits</li>
                            <li><strong>Order:</strong> perfect archive of documentation</li>
                        </ul>
                    </div>
                </div>
    ...
    <section id="lead-form" class="section section--gray" style="border-top: 1px solid var(--nk-gray-100); padding-top: 40px; padding-bottom: 80px;">
        <div class="container" style="max-width: 800px;">
            <div class="section__header section__header--center" style="margin-bottom: 60px;">
                <div class="section__label">Risk assessment</div>
                <h2 class="section__title">Free express assessment</h2>
                <p class="section__subtitle" style="margin-bottom: 0;">Leave a request for a preliminary analysis of your accounting state. We will contact you within 30 minutes.</p>
            </div>
                ...
                <form class="cta-crystal__form" action="#" method="POST" style="display: grid; gap: 24px;">
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 24px;">
                        <div class="cta-crystal__field">
                            ...
                            <label for="sr-name">Your name</label>
                        </div>
                        <div class="cta-crystal__field">
                            <input type="tel" placeholder=" " required id="sr-phone">
                            <label for="sr-phone">Phone (+992)</label>
                        </div>
                    </div>
                    <div class="cta-crystal__field">
                        <input type="text" placeholder=" " id="sr-company">
                        <label for="sr-company">Company name (optional)</label>
                    </div>
                    <button type="submit" class="cta-crystal__btn"><span>Estimate cost</span><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M5 12h14"/><path d="m12 5 7 7-7 7"/></svg></button>
