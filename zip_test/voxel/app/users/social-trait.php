...
trait Social_Trait {
	...
	public function has_reached_message_rate_limit(): bool {
		if ( current_user_can( 'administrator' ) ) {
			return false;
		}

		return \Voxel\Direct_Messages\user_has_reached_message_rate_limit( $this->get_id() );
	}

	public function has_reached_new_chat_limit(): bool {
		if ( current_user_can( 'administrator' ) ) {
			return false;
		}

		return \Voxel\Direct_Messages\user_has_reached_new_chat_limit( $this->get_id() );
	}
