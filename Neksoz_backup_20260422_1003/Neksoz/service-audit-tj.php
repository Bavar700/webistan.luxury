    ...
    <section class="section">
        <div class="container">
            ...
            <div class="section__header section__header--center" style="margin-bottom: 60px;">
                ...
                <p class="section__subtitle">Мо на танҳо хатогиҳоро меҷӯем, мо пойдевори эътимодро байни соҳибон ва сармоягузорон эҷод мекунем.</p>
            </div>
            ...
            <div class="services-grid" style="grid-template-columns: repeat(2, 1fr); gap: 40px;">
                ...
                <div class="service-card" style="height: 100%;">
                    ...
                    <h3 class="service-card__title">Кай аудит <br>лозим аст?</h3></div></div>
                    <div class="service-card__tasks">
                        <ul class="service-card__list">
                            <li>Тасдиқи ҳисобот ба сармоягузорон</li>
                            <li>Шубҳаҳо ба хадамоти молиявии ҷорӣ</li>
                            <li>Омодагӣ ба фурӯши тиҷорат</li>
                            <li>Ҷалби қарзҳои бонкӣ</li>
                            <li>Назорати сусти дохилӣ</li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="service-card" style="height: 100%;">
                    ...
                    <div class="service-card__tasks">
                        <ul class="service-card__list">
                            <li>Баҳодиҳии системаҳои назорати дохилӣ</li>
                            <li>Санҷиши қонунияти сабтҳо</li>
                            <li>Таҳлили дурнамои рӯйдодҳои оянда</li>
                            <li>Ошкор намудани захираҳои рушд</li>
                ...
                <div class="service-card" style="height: 100%;">
                    ...
                    <div class="service-card__tasks">
                        <ul class="service-card__list">
                            ...
                            <li>Тартиб додани барномаи муфассал</li>
                            <li>Ҷамъоварии далелҳо ва маълумот</li>
                            <li>Ташаккули хулосаи ниҳоӣ</li>
                            <li>Муаррифии натиҷаҳо ба соҳибон</li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="service-card" style="height: 100%;">
                    ...
                    <div class="service-card__tasks">
                        <ul class="service-card__list">
                            ...
                            <li>Харитаи муфассали хавфҳои молиявӣ</li>
                            <li>Тавсияҳо оид ба беҳтарсозии равандҳо</li>
                            <li>Шаффофияти тамоми равандҳои тиҷоратӣ</li>
                            <li>Кафолати амният барои сармоягузорон</li>
                        </ul>
                    </div>
                </div>
    ...
    <section id="lead-form" class="section section--gray" style="border-top: 1px solid var(--nk-gray-100); padding-top: 40px; padding-bottom: 80px;">
        <div class="container" style="max-width: 800px;">
            <div class="section__header section__header--center" style="margin-bottom: 60px;">
                ...
                <p class="section__subtitle" style="margin-bottom: 0;">Барои таҳлили пешакии аудиторӣ дархост гузоред. Мо бо шумо дар давоми 30 дақиқа тамос хоҳем гирифт.</p>
            </div>
            ...
            <div class="cta-crystal__form-box" style="background: var(--nk-white); padding: 60px; border-radius: 32px; box-shadow: 0 40px 100px rgba(0, 13, 51, 0.08); border: 1px solid var(--nk-gray-50);">
                <form class="cta-crystal__form" action="#" method="POST" style="display: grid; gap: 24px;">
                    ...
                    <button type="submit" class="cta-crystal__btn"><span>Дархости аудит</span><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M5 12h14"/><path d="m12 5 7 7-7 7"/></svg></button>
