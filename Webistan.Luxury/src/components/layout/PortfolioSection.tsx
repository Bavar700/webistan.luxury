                        ...
                        >
                            ...
                            <div className="relative z-10 text-center flex flex-col items-center">
                                <div className="space-y-4 w-full">
                                    ...
                                    <h3 className="text-base md:text-3xl font-display font-light group-hover:text-accent transition-all duration-1000 tracking-[0.2em] uppercase leading-relaxed md:leading-none">
                                        {s.title.toLowerCase().includes('yaghnob.com') ? (
                                            <a 
                                              href="https://yaghnob.com" 
                                              target="_blank" 
                                              rel="noopener noreferrer"
                                              className="hover:underline decoration-accent/30 underline-offset-8"
                                            >
                                                {s.title}
                                            </a>
                                        ) : (
