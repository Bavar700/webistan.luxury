        ...
        <div class="container hero__container" style="position:relative;z-index:2;">
            <div class="hero__content">
                <h1 class="hero__title">
                    Экспертные<br>
                    <span class="text-gradient">налоговые консультации</span><br>
                    <span>бизнеса</span>
                </h1>
                <p class="hero__desc">
                    Законная оптимизация налоговой нагрузки и минимизация рисков перед визитами контролирующих органов.
                </p>
            </div>
            
            <div class="hero__actions--right">
                <a href="#lead-form" class="btn btn--primary" style="padding: 16px 36px; font-size: 11px;">
                    <span>Снизить риски</span>
    ...
    <section class="section">
        <div class="container">
            <div class="section__header section__header--center" style="margin-bottom: 60px;">
                <div class="section__label">Налоговая безопасность</div>
                <h2 class="section__title">Ваш законный путь к экономии</h2>
                <p class="section__subtitle">Мы помогаем платить налоги правильно, исключая переплаты и защищая от претензий фискальных органов.</p>
            </div>
            ...
            <div class="services-grid" style="grid-template-columns: repeat(2, 1fr); gap: 40px;">
                ...
                <div class="service-card" style="height: 100%;">
                    ...
                    <div class="service-card__tasks">
                        <ul class="service-card__list">
                            ...
                            <li>Планируется сделка с крупными рисками</li>
                            <li>Нужен расчет последствий новых проектов</li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="service-card" style="height: 100%;">
                    ...
                    <div class="service-card__tasks">
                        <ul class="service-card__list">
                            ...
                            <li>Разработка эффективной налоговой политики</li>
                            <li>Проверка соблюдения законодательства</li>
                            <li>Представительство в налоговых спорах</li>
                            <li>Оптимизация налоговых выплат в рамках закона</li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="service-card" style="height: 100%;">
                    ...
                    <div class="service-card__tasks">
                        <ul class="service-card__list">
                            <li>Глубокий анализ текущей налоговой модели</li>
                            <li>Поиск законных способов снижения нагрузки</li>
                            <li>Устранение ошибок, привлекающих внимание</li>
                            <li>Защита интересов клиента в инстанциях</li>
                            <li>Полное сопровождение во время проверок</li>
                        </ul>
                    </div>
                </div>
    ...
    <section id="lead-form" class="section section--gray" style="border-top: 1px solid var(--nk-gray-100); padding-top: 40px; padding-bottom: 80px;">
        <div class="container" style="max-width: 800px;">
            <div class="section__header section__header--center" style="margin-bottom: 60px;">
                ...
                <p class="section__subtitle" style="margin-bottom: 0;">Оставьте заявку на предварительный анализ налоговой нагрузки. Мы свяжемся с вами в течение 30 минут.</p>
            </div>
