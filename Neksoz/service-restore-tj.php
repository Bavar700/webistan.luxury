<?php
/**
 * Template Name: Service: Restore (TJ)
 */
get_header();
?>
...
<main class="site-main">
        ...
        <div class="container hero__container" style="position:relative;z-index:2;">
            ...
            <div class="hero__actions--right">
                <a href="#lead-form" class="btn btn--primary" style="padding: 16px 36px; font-size: 11px;">
                    <span>Барқарор намудани тартибот</span>
    ...
    <section class="section">
        <div class="container">
            ...
            <div class="section__header section__header--center" style="margin-bottom: 60px;">
                ...
                <p class="section__subtitle">Мо на танҳо иштибоҳҳоро ислоҳ мекунем, балки низоми боэътимоди молиявиро аз сифр бунёд месозем.</p>
            </div>
            ...
            <div class="services-grid" style="grid-template-columns: repeat(2, 1fr); gap: 40px;">
                ...
                <div class="service-card" style="height: 100%;">
                    ...
                    <h3 class="service-card__title">Ин хизматрасонӣ кай <br>зарур аст?</h3></div>
                    <div class="service-card__tasks">
                        <ul class="service-card__list">
                            <li>Муҳосиб иваз шуд, санадҳо супорида нашудаанд</li>
                            <li>Санадҳои ибтидоӣ ё пойгоҳи 1С гум шудаанд</li>
                            <li>Санҷиши андоз наздик аст</li>
                            <li>Суратҳисобҳо аз ҷониби мақомоти давлатӣ баста шудаанд</li>
                ...
                <div class="service-card" style="height: 100%;">
                    ...
                    <h3 class="service-card__title">Тафсилоти <br>раванд</h3></div>
                    <div class="service-card__tasks">
                        <ul class="service-card__list">
                            <li><strong>Аудити ибтидоӣ:</strong> арзёбии миқёси мушкилот</li>
                            <li><strong>Ҷамъоварии маълумот:</strong> дархостҳо ба бонкҳо ва шарикони тиҷоратӣ</li>
                            <li><strong>Воридкунӣ ба пойгоҳ:</strong> барқарорсозии тамоми давраҳо</li>
                            <li><strong>Муқоиса бо мақомоти суғурта ва андоз:</strong> рафъи ҳамаи номувофиқатӣ</li>
                            <li><strong>Бардоштани ҳабс:</strong> кушодани суратҳисобҳои Шумо</li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="service-card" style="height: 100%;">
                    ...
                    <h3 class="service-card__title">Нақшаи марҳилавии <br>ҳамкорӣ</h3></div>
                    <div class="service-card__tasks">
                        <ul class="service-card__list">
                            <li>Имзои қарордод ва NDA (Созишномаи махфият)</li>
                            <li>Арзёбии фаврии ройгони ҳаҷми кор</li>
                            <li>Марҳилаи фаъоли барқарорсозии маълумот</li>
                            <li>Ҳимояи натиҷа дар назди мақомоти давлатӣ</li>
                            <li>Супоридани пойгоҳи тозаи 1С ва тавсияҳо</li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="service-card" style="height: 100%;">
                    ...
                    <div class="service-card__tasks">
                        <ul class="service-card__list">
                            <li><strong>Қонунмандии пурра:</strong> тибқи қонунҳои ҶТ</li>
                            <li><strong>Хатарҳои сифрӣ:</strong> набудани пеня ва ҷаримаҳо</li>
                            <li><strong>Шаффофият:</strong> Шумо фоидаи воқеиро мебинед</li>
                            <li><strong>Амният:</strong> ҳифз аз санҷишҳо</li>
                            <li><strong>Тартибот:</strong> бойгонии беҳтарини санадҳо</li>
                        </ul>
                    </div>
                </div>
    ...
    <section id="lead-form" class="section section--gray" style="border-top: 1px solid var(--nk-gray-100); padding-top: 40px; padding-bottom: 80px;">
        <div class="container" style="max-width: 800px;">
            <div class="section__header section__header--center" style="margin-bottom: 60px;">
                <div class="section__label">Арзёбии хатарҳо</div>
                <h2 class="section__title">Арзёбии фаврии ройгон</h2>
                <p class="section__subtitle" style="margin-bottom: 0;">Барои таҳлили пешакии ҳолати баҳисобгирии худ дархост гузоред.<br>Мо дар давоми 30 дақиқа бо Шумо дар тамос хоҳем шуд.</p>
            </div>
