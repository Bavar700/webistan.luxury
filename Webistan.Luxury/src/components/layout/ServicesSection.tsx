                        ...
                        >
                            ...
                            <div className="relative z-10 text-center flex flex-col items-center">
                                <div className="space-y-4 w-full">
                                    ...
                                    <h3 className="text-base md:text-2xl font-display font-light group-hover:text-accent transition-all duration-1000 tracking-[0.1em] uppercase leading-tight pb-2">
                                        {t(`items.${s.key}.title`)}
                                    </h3>
                                </div>
