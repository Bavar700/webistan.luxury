<?php
/**
 * Template Name: Service: Secretariat (TJ)
 */
get_header();
?>
...
<main class="site-main">
        ...
        <div class="container hero__container" style="position:relative;z-index:2;">
            <div class="hero__content">
                ...
                <h1 class="hero__title">
                    <span style="white-space: nowrap;">Хидматҳои касбии</span><br>
                    <span class="text-gradient" style="white-space: nowrap;">котибот барои тиҷорат</span>
                </h1>
                <p class="hero__desc">
            ...
            <div class="hero__actions--right">
                <a href="#lead-form" class="btn btn--primary" style="padding: 16px 36px; font-size: 11px;">
                    <span>Вогузории корҳои якнавохт</span>
    ...
    <section class="section">
        <div class="container">
            <div class="section__header section__header--center" style="margin-bottom: 60px;">
                <div class="section__label">Мутобиқати муҳоҷиратӣ</div>
                <h2 class="section__title">Қонунмандӣ ва сафарбарии ҳайати кормандон</h2>
                <p class="section__subtitle">Мо тамоми корҳои коғазбозиро ба дӯш мегирем, то мутахассисони<br>Шумо тавонанд бе таваққуфи зиёдатӣ фаъолият кунанд.</p>
            </div>
            ...
            <div class="services-grid" style="grid-template-columns: repeat(2, 1fr); gap: 40px;">
                ...
                <div class="service-card" style="height: 100%;">
                    ...
                    <h3 class="service-card__title">Дастгирӣ кай <br>зарур аст?</h3></div>
                    <div class="service-card__tasks">
                        <ul class="service-card__list">
                            <li>Ҷалби мутахассисони хориҷӣ</li>
                            <li>Гирифтани раводидҳои корӣ (навъи M)</li>
                            <li>Тамдиди бақайдгирӣ дар ХШБ (ОВИР)</li>
                            <li>Кор бо Дипсервис (навъи K)</li>
                            <li>Зарурати тарҷумаи санадҳои ҳуқуқӣ</li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="service-card" style="height: 100%;">
                    ...
                    <div class="service-card__tasks">
                        <ul class="service-card__list">
                            ...
                            <li>Омодасозии даъватномаҳо ва иҷозатномаҳо</li>
                            <li>Тамдиди раводидҳо (навъҳои M, K, O-2)</li>
                            <li>Гирифтани кортҳои Дипсервис</li>
                            <li>Тарҷумаи касбии санадҳо</li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="service-card" style="height: 100%;">
                    ...
                    <div class="service-card__tasks">
                        <ul class="service-card__list">
                            <li>Муайян намудани навъи раводид ва рӯйхат</li>
                            <li>Санҷиши санадҳо барои мутобиқат ба қонун</li>
                            <li>Пешниҳоди санадҳо ба мақомоти давлатӣ</li>
                            <li>Ҳамкорӣ бо хадамоти муҳоҷират</li>
                            <li>Супоридани иҷозатномаҳои омода ба муштарӣ</li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="service-card" style="height: 100%;">
                    ...
                    <div class="service-card__tasks">
                        <ul class="service-card__list">
                            <li>Ҳолати қонунии тамоми мутахассисон</li>
                            <li>Набудани мушкилот бо қонунгузорӣ</li>
                            <li>Бардоштани сарборӣ аз роҳбарияти ширкат</li>
                            <li>Муҳлатҳои кӯтоҳи гирифтани иҷозатномаҳо</li>
                            <li>Санадҳои ба таври саҳеҳ тарҷумашуда</li>
                        </ul>
                    </div>
                </div>
    ...
    <section id="lead-form" class="section section--gray" style="border-top: 1px solid var(--nk-gray-100); padding-top: 40px; padding-bottom: 80px;">
        <div class="container" style="max-width: 800px;">
            <div class="section__header section__header--center" style="margin-bottom: 60px;">
                <div class="section__label">Арзёбии раводид</div>
                <h2 class="section__title">Машварати ройгон</h2>
                <p class="section__subtitle" style="margin-bottom: 0;">Барои арзёбии пешакии муҳоҷиратӣ дархост гузоред.<br>Мо дар давоми 30 дақиқа бо Шумо дар тамос хоҳем шуд.</p>
            </div>
                ...
                <form class="cta-crystal__form" action="#" method="POST" style="display: grid; gap: 24px;">
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 24px;">
                        <div class="cta-crystal__field">
                            ...
                            <label for="ss-name">Номи Шумо</label>
                        </div>
                        <div class="cta-crystal__field">
                    ...
                    <div class="cta-crystal__field">
                        ...
                        <label for="ss-company">Номи ширкат (ихтиёрӣ)</label>
                    </div>
                    <button type="submit" class="cta-crystal__btn"><span>Гирифтани раводид</span><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M5 12h14"/><path d="m12 5 7 7-7 7"/></svg></button>
