    ...
    <div class="container" style="position:relative; z-index:10;">
        <div class="footer-minimal">
            ...
            <nav class="footer-minimal__nav footer-nav--icons fade-up">
                ...
                <a href="<?php echo nk_link('/services', 'tj'); ?>">
                    ...
                    <?php _e('Хидмат', 'neksoz'); ?>
                </a>
                <a href="<?php echo nk_link('/team', 'tj'); ?>">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>
                    <?php _e('Даста', 'neksoz'); ?>
                </a>
                <a href="<?php echo nk_link('/news', 'tj'); ?>">
                ...
                <a href="<?php echo nk_link('/contacts', 'tj'); ?>">
            ...
            <div class="footer-platinum__social-hub fade-up" style="margin: 30px 0 0 0;">
                <div class="footer-platinum__socials">
                    ...
                    <a href="https://wa.me/<?php echo preg_replace('/[^0-9]/', '', function_exists('pll__') ? pll__('+992 44 600 00 00') : '+992446000000'); ?>" class="footer-platinum__social-btn" title="WhatsApp">
                    ...
                    <a href="tel:<?php echo preg_replace('/[^0-9+]/', '', function_exists('pll__') ? pll__('+992 44 600 00 00') : '+992446000000'); ?>" class="footer-platinum__social-btn" title="<?php echo function_exists('pll__') ? pll__('Занг задан') : 'Call'; ?>">
                        <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 22 16.92z"/></svg>
                    </a>
                    <a href="mailto:<?php echo function_exists('pll__') ? pll__('info@webistan.tj') : 'info@neksoz.com'; ?>" class="footer-platinum__social-btn" title="E-mail">
    ...
    <div class="map-modal__container">
        ...
        <div class="map-modal__content">
            ...
            <div class="map-modal__card">
                <strong>Дафтари мо:</strong>
                <span>Тоҷикистон, Душанбе, хиёбони Рӯдакӣ 42</span>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="modal__content" style="padding: 0;">
            <div class="cta-crystal__grid">
                ...
                <div class="cta-crystal__content">
                    <h3 class="cta-crystal__title"><span class="text-gradient">Омодаед муваффақияти худро</span><br>густариш диҳед?</h3>
                    <p class="cta-crystal__text">Имрӯз дархост гузоред ва мо барои шумо стратегияи инфиродии рушди тиҷорататонро таҳия мекунем.</p>
                </div>
                ...
                <div class="cta-crystal__form-wrapper">
                    <form action="#" class="cta-crystal__form">
                        <div class="cta-crystal__field">
                            ...
                            <label for="m-f-name">Номи шумо</label>
                        </div>
                        <div class="cta-crystal__field">
                        ...
                        <div class="cta-crystal__field nx-dropdown" id="modalDropdown">
                            ...
                            <label for="m-f-service-input">Самтро интихоб кунед <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" style="margin-left: 4px; display: inline-block; vertical-align: middle;"><path d="m6 9 6 6 6-6"/></svg></label>
                            <div class="nx-dropdown__panel">
                                <div class="nx-dropdown__option" data-val="legal">Дастгирии ҳуқуқӣ</div>
                                <div class="nx-dropdown__option" data-val="tax">Машварати андозӣ</div>
                                <div class="nx-dropdown__option" data-val="audit">Аудит ва ҳисобдорӣ</div>
                                <div class="nx-dropdown__option" data-val="accounting">Пешбурди ҳисобдорӣ</div>
                                <div class="nx-dropdown__option" data-val="automation">Автоматикунонии тиҷорат</div>
                                <div class="nx-dropdown__option" data-val="consulting">Консалтинги тиҷоратӣ</div>
                                <div class="nx-dropdown__option" data-val="secretariat">Хидматрасонии котиботӣ</div>
                                <div class="nx-dropdown__option" data-val="restore">Барқарорсозии баҳисобгирӣ</div>
                        ...
                        <div class="cta-crystal__field">
                            ...
                            <label for="m-f-msg">Мӯҳтавои дархости шумо</label>
                        </div>
