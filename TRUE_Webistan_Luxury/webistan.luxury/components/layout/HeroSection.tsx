        ...
        >
          ...
          <motion.div variants={itemVariants} className="flex flex-col items-center text-center w-full">
            ...
            <div className="flex items-center justify-center w-full mb-[30px]">
              <span className="text-3xl md:text-6xl uppercase tracking-[0.2em] font-medium leading-none -mr-[0.2em] hero-shimmer">
                {t('middle')}
              </span>
            </div>

            {/* 3. BASE TITLE */}
            <h1 className="relative text-4xl sm:text-6xl md:text-7xl font-display font-bold tracking-[0.05em] leading-none uppercase -mr-[0.05em] mb-[30px]">
