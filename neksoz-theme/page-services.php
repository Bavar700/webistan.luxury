    ...
    <section class="hero hero--internal">
        ...
        <div class="container hero__container" style="position:relative;z-index:2;">
            ...
            <div class="hero__actions--right">
                <a href="<?php echo home_url('/contacts'); ?>" class="btn btn--primary">ÐšÐ¾Ð½ÑÑƒÐ»ÑŒÑ‚Ð°Ñ†Ð¸Ñ</a>
            </div>
        </div>
    </section>
    ...
    <section class="section section--gray">
        <div class="container">
            <div class="services-grid">
                ...
                <!-- 2. Ð’Ð¾ÑÑÑ‚Ð°Ð½Ð¾Ð²Ð»ÐµÐ½Ð¸Ðµ -->
                ...
                <div class="service-card service-card--alt fade-up fade-up-delay-1">
                    ...
                    <p class="service-card__text">Ð’Ñ‹ Ð¿Ð¾Ð»ÑƒÑ‡Ð°ÐµÑ‚Ðµ Ð¿Ð¾Ð»Ð½ÑƒÑŽ Ñ„Ð¸Ð½Ð°Ð½ÑÐ¾Ð²ÑƒÑŽ Ð¿Ñ€Ð¾Ð·Ñ€Ð°Ñ‡Ð½Ð¾ÑÑ‚ÑŒ Ð¸ Ñ‚Ð¾Ñ‡Ð½Ñ‹Ðµ Ð´Ð°Ð½Ð½Ñ‹Ðµ Ð´Ð»Ñ Ð¿Ñ€Ð¸Ð½ÑÑ‚Ð¸Ñ Ñ€ÐµÑˆÐµÐ½Ð¸Ð¹, ÐºÐ¾Ñ‚Ð¾Ñ€Ñ‹Ðµ Ñ€ÐµÐ°Ð»ÑŒÐ½Ð¾ ÑƒÐ²ÐµÐ»Ð¸Ñ‡Ð¸Ð²Ð°ÑŽÑ‚ Ð²Ð°ÑˆÑƒ Ð¿Ñ€Ð¸Ð±Ñ‹Ð»ÑŒ.</p>
                    <a href="<?php echo home_url('/service-management'); ?>" class="service-card__link">ÐŸÐ¾Ð´Ñ€Ð¾Ð±Ð½ÐµÐµ â†’</a>
                </div>

                <!-- 9. ÐÐ²Ñ‚Ð¾Ð¼Ð°Ñ‚Ð¸Ð·Ð°Ñ†Ð¸Ñ -->
                <div class="service-card fade-up fade-up-delay-2">
                    <div class="service-card__icon">
                    ...
                    <p class="service-card__text">Ð’Ñ‹ Ð¾ÑÐ²Ð¾Ð±Ð¾Ð¶Ð´Ð°ÐµÑ‚Ðµ ÐºÐ¾Ð¼Ð°Ð½Ð´Ñƒ Ð¾Ñ‚ Ñ€ÑƒÑ‚Ð¸Ð½Ñ‹ Ð¸ Ð¸ÑÐºÐ»ÑŽÑ‡Ð°ÐµÑ‚Ðµ Ð¾ÑˆÐ¸Ð±ÐºÐ¸, Ð¿ÐµÑ€ÐµÐ²Ð¾Ð´Ñ ÑƒÐ¿Ñ€Ð°Ð²Ð»ÐµÐ½Ð¸Ðµ Ð² Ð±Ñ‹ÑÑ‚Ñ€ÑƒÑŽ Ð¸ Ñ‚Ð¾Ñ‡Ð½ÑƒÑŽ Ñ†Ð¸Ñ„Ñ€Ð¾Ð²ÑƒÑŽ ÑÑ€ÐµÐ´Ñƒ.</p>
