					...
					<div class="ts-group">
						...
						<div class="x-row">
							<div class="x-col-12 ts-form-group">
								<p>Synchronize Voxel template names and Elementor template types.</p> <br>
								<a
									class="ts-button ts-outline"
									href="<?php echo esc_url( wp_nonce_url( admin_url( 'admin-post.php?action=voxel_sync_template_data' ), 'voxel_sync_template_data' ) ) ?>"
								>
									Sync data
								</a>
							</div>
