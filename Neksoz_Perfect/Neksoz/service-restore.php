        ...
        <div class="container">
            ...
            <div class="services-grid" style="grid-template-columns: repeat(2, 1fr); gap: 40px;">
                ...
                <div class="service-card" style="height: 100%;">
                    ...
                    <h3 class="service-card__title">Когда нужна <br>эта услуга?</h3></div>
                ...
                <div class="service-card" style="height: 100%;">
                    ...
                    <h3 class="service-card__title">Детализация <br>процесса</h3></div>
                    <div class="service-card__tasks">
                        <ul class="service-card__list">
                ...
                <div class="service-card" style="height: 100%;">
                    ...
                    <h3 class="service-card__title">Пошаговый план <br>сотрудничества</h3></div>
                    <div class="service-card__tasks">
                        <ul class="service-card__list">
    ...
    <section id="lead-form" class="section section--gray" style="border-top: 1px solid var(--nk-gray-100); padding-top: 40px; padding-bottom: 80px;">
        <div class="container" style="max-width: 800px;">
            <div class="section__header section__header--center" style="margin-bottom: 60px;">
                ...
                <p class="section__subtitle" style="margin-bottom: 0;">Оставьте заявку на предварительный анализ состояния вашего учета.<br>Мы свяжемся с вами в течение 30 минут.</p>
            </div>
