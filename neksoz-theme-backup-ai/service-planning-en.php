<?php
/**
 * Template Name: Service: Business Planning (EN)
 */
get_header();
?>
    ...
    <section class="hero hero--internal">
        ...
        <div class="container hero__container" style="position:relative;z-index:2;">
            <div class="hero__content">
                <div class="hero__badge">Planning Department</div>
                <h1 class="hero__title">
                    Strategic<br>
                    <span class="text-gradient">Business Planning &</span><br>
                    <span style="color: var(--nk-blue);">Modeling</span>
                </h1>
                <p class="hero__desc">
                    Development of high-precision business plans and financial models that ensure success in attracting investment and strategic project launches.
                </p>
            </div>
    ...
    <section class="section">
        <div class="container">
            <div class="section__header section__header--center" style="margin-bottom: 60px;">
                <div class="section__label">Invest Readiness</div>
                <h2 class="section__title">Turning Ideas into Profitable Assets</h2>
                <p class="section__subtitle">We provide the technical and financial justification your partners and banks need to see.</p>
            </div>

            <div class="services-grid" style="grid-template-columns: repeat(2, 1fr); gap: 40px;">
                
                <!-- CARD 1: When is a business plan needed? -->
                <div class="service-card service-card--alt" style="height: 100%;">
                    ...
                    <h3 class="service-card__title">When is a <br>Plan Needed?</h3>
                    <div class="service-card__tasks">
                        <ul class="service-card__list">
                            <li>Attracting investments or bank loans</li>
                            <li>Idea evaluation before project launch</li>
                            <li>Obtaining benefits or government grants</li>
                            <li>Protecting strategy before shareholders</li>
                            <li>Scaling your current business model</li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="service-card" style="height: 100%;">
                    ...
                    <div class="service-card__tasks">
                        <ul class="service-card__list">
                            ...
                            <li>Developing a detailed financial model</li>
                            <li>Feasibility study (FS) to international standards</li>
                            <li>Preparing Pitch Decks for investors</li>
                            <li>Defense of plans before financial institutions</li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="service-card service-card--alt" style="height: 100%;">
                    ...
                    <div class="service-card__tasks">
                        <ul class="service-card__list">
                            <li>Collection and systemization of input data</li>
                            <li>Mathematical modeling of profit/loss</li>
                            <li>Writing descriptive parts to standards</li>
                            <li>Adjustment for specific bank requirements</li>
                ...
                <div class="service-card" style="height: 100%;">
                    ...
                    <div class="service-card__tasks">
                        <ul class="service-card__list">
                            <li>Document that increases chances for capital</li>
                            <li>Clear understanding of all risks and timelines</li>
                            <li>Ready-made action plan for project launch</li>
                            <li>Professional-grade financial model</li>
                            <li>Justification of ROI for potential partners</li>
                        </ul>
                    </div>
                </div>
    ...
    <section id="lead-form" class="section section--gray" style="border-top: 1px solid var(--nk-gray-100); padding-top: 40px; padding-bottom: 80px;">
        <div class="container" style="max-width: 800px;">
            <div class="section__header section__header--center" style="margin-bottom: 60px;">
                ...
                <p class="section__subtitle" style="margin-bottom: 0;">Leave a request for a preliminary evaluation of your project. We will contact you within 30 minutes.</p>
            </div>
            ...
            <div class="cta-crystal__form-box" style="background: var(--nk-white); padding: 60px; border-radius: 32px; box-shadow: 0 40px 100px rgba(0, 13, 51, 0.08); border: 1px solid var(--nk-gray-50);">
                <form class="cta-crystal__form" action="#" method="POST" style="display: grid; gap: 24px;">
                    ...
                    <button type="submit" class="cta-crystal__btn"><span>Get Your Plan</span><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M5 12h14"/><path d="m12 5 7 7-7 7"/></svg></button>
