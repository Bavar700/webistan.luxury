    ...
    <section class="section">
        <div class="container">
            ...
            <div class="section__header section__header--center" style="margin-bottom: 60px;">
                ...
                <h2 class="section__title">Комплексный подход к восстановлению</h2>
                <p class="section__subtitle">Мы не просто исправляем ошибки, а выстраиваем надежную финансовую систему с нуля.</p>
            </div>
            ...
            <div class="services-grid" style="grid-template-columns: repeat(2, 1fr); gap: 40px;">
                ...
                <div class="service-card" style="height: 100%;">
                    ...
                    <h3 class="service-card__title">Когда нужна <br>эта услуга?</h3></div></div>
                    <div class="service-card__tasks">
                        <ul class="service-card__list">
                            <li>Сменился бухгалтер, дела не переданы</li>
                            <li>Утеряна первичка или базы 1С</li>
                            <li>Близится налоговая проверка</li>
                            <li>Счета заблокированы госорганами</li>
                            <li>Учет не велся более 3-х месяцев</li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="service-card" style="height: 100%;">
                    ...
                    <h3 class="service-card__title">Детализация <br>процесса</h3></div></div>
                    <div class="service-card__tasks">
                        <ul class="service-card__list">
                            <li><strong>Первичный аудит:</strong> оценка масштаба проблем</li>
                            <li><strong>Сбор данных:</strong> запросы в банки и контрагентам</li>
                            <li><strong>Внесение в базу:</strong> восстановление всех периодов</li>
                            <li><strong>Сверка с ФСЗН:</strong> устранение всех расхождений</li>
                            <li><strong>Снятие ареста:</strong> разблокировка ваших счетов</li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="service-card" style="height: 100%;">
                    ...
                    <h3 class="service-card__title">Пошаговый план <br>сотрудничества</h3></div></div>
                    <div class="service-card__tasks">
                        <ul class="service-card__list">
                            <li>Подписание договора и NDA</li>
                            <li>Бесплатная экспресс-оценка объема</li>
                            <li>Этап активного восстановления данных</li>
                            <li>Защита результата перед госорганами</li>
                            <li>Передача чистой базы 1С и рекомендаций</li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="service-card" style="height: 100%;">
                    ...
                    <div class="service-card__tasks">
                        <ul class="service-card__list">
                            <li><strong>Полная легальность:</strong> по законам РТ</li>
                            <li><strong>Нулевые риски:</strong> отсутствие пеней и штрафов</li>
                            <li><strong>Прозрачность:</strong> вы видите реальную прибыль</li>
                            <li><strong>Безопасность:</strong> защита от проверок</li>
                            <li><strong>Порядок:</strong> идеальный архив документации</li>
                        </ul>
                    </div>
                </div>
    ...
    <section id="lead-form" class="section section--gray" style="border-top: 1px solid var(--nk-gray-100); padding-top: 40px; padding-bottom: 80px;">
        <div class="container" style="max-width: 800px;">
            <div class="section__header section__header--center" style="margin-bottom: 60px;">
                ...
                <p class="section__subtitle" style="margin-bottom: 0;">Оставьте заявку на предварительный анализ состояния вашего учета. Мы свяжемся с вами в течение 30 минут.</p>
            </div>
                ...
                <form class="cta-crystal__form" action="#" method="POST" style="display: grid; gap: 24px;">
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 24px;">
                        <div class="cta-crystal__field">
                            ...
                            <label for="sr-name">Ваше имя</label>
                        </div>
                        <div class="cta-crystal__field">
