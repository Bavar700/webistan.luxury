<?php
if (function_exists('nk_get_current_lang') && nk_get_current_lang() === 'tj' && !get_query_var('is_footer_tj')) {
    set_query_var('is_footer_tj', true);
    get_template_part('footer', 'tj');
    return;
}
?>
<!-- â•â•â•â•â•â•â•â•â•â•â• FOOTER â€” CINEMATIC HERITAGE â•â•â•â•â•â•â•â•â•â•â• -->
<footer class="footer-platinum">
        ...
        <div class="footer-minimal">
            ...
            <div class="footer-platinum__social-hub fade-up" style="margin: 30px 0 0 0;">
                <div class="footer-platinum__socials">
                    ...
                    <a href="tel:+992446000000" class="footer-platinum__social-btn" title="ÐŸÐ¾Ð·Ð²Ð¾Ð½Ð¸Ñ‚ÑŒ">
    ...
    <div class="container" style="position:relative; z-index:10;">
        <div class="footer-platinum__bottom">
            <p>&copy; <?php echo date('Y'); ?> NEKSOZ. Ð’ÑÐµ Ð¿Ñ€Ð°Ð²Ð° Ð·Ð°Ñ‰Ð¸Ñ‰ÐµÐ½Ñ‹.</p>
            <div class="footer-platinum__legal">
                <a href="<?php echo home_url('/privacy-policy'); ?>">ÐšÐ¾Ð½Ñ„Ð¸Ð´ÐµÐ½Ñ†Ð¸Ð°Ð»ÑŒÐ½Ð¾ÑÑ‚ÑŒ</a>
                <a href="<?php echo home_url('/terms'); ?>">Ð£ÑÐ»Ð¾Ð²Ð¸Ñ</a>
            </div>
        </div>
    </div>
</footer>
    ...
    <div class="map-modal__container">
        ...
        <div class="map-modal__content">
            ...
            <div class="map-modal__card">
                <strong>ÐÐ°Ñˆ Ð¾Ñ„Ð¸Ñ:</strong>
                <span>Ð¢Ð°Ð´Ð¶Ð¸ÐºÐ¸ÑÑ‚Ð°Ð½, Ð”ÑƒÑˆÐ°Ð½Ð±Ðµ, Ð¿Ñ€-Ñ‚ Ð ÑƒÐ´Ð°ÐºÐ¸ 42</span>
            </div>
        </div>
    </div>
</div>

<!-- â•â•â•â•â•â•â•â•â•â•â• SERVICE REQUEST MODAL â•â•â•â•â•â•â•â•â•â•â• -->
        ...
        <div class="modal__content" style="padding: 0;">
            <div class="cta-crystal__grid">
                ...
                <div class="cta-crystal__content">
                    <h3 class="cta-crystal__title"><span class="text-gradient">Ð“Ð¾Ñ‚Ð¾Ð²Ñ‹ Ð¼Ð°ÑÑˆÑ‚Ð°Ð±Ð¸Ñ€Ð¾Ð²Ð°Ñ‚ÑŒ</span><br>ÑÐ²Ð¾Ð¹ ÑƒÑÐ¿ÐµÑ…?</h3>
                    <p class="cta-crystal__text">ÐžÑÑ‚Ð°Ð²ÑŒÑ‚Ðµ Ð·Ð°ÑÐ²ÐºÑƒ ÑÐµÐ³Ð¾Ð´Ð½Ñ, Ð¸ Ð¼Ñ‹ Ñ€Ð°Ð·Ñ€Ð°Ð±Ð¾Ñ‚Ð°ÐµÐ¼ Ð´Ð»Ñ Ð²Ð°Ñ Ð¿ÐµÑ€ÑÐ¾Ð½Ð°Ð»ÑŒÐ½ÑƒÑŽ ÑÑ‚Ñ€Ð°Ñ‚ÐµÐ³Ð¸ÑŽ Ñ€Ð°Ð·Ð²Ð¸Ñ‚Ð¸Ñ Ð²Ð°ÑˆÐµÐ³Ð¾ Ð±Ð¸Ð·Ð½ÐµÑÐ°.</p>
                </div>
                ...
                <div class="cta-crystal__form-wrapper">
                    <form action="#" class="cta-crystal__form">
                        <div class="cta-crystal__field">
                            ...
                            <label for="m-f-name">Ð’Ð°ÑˆÐµ Ð¸Ð¼Ñ</label>
                        </div>
                        <div class="cta-crystal__field">
                            <input type="tel" placeholder=" " required id="m-f-phone">
                            <label for="m-f-phone">Ð¢ÐµÐ»ÐµÑ„Ð¾Ð½ (+992)</label>
                        </div>
                        <div class="cta-crystal__field nx-dropdown" id="modalDropdown">
                            ...
                            <label for="m-f-service-input">Ð’Ñ‹Ð±Ñ€Ð°Ñ‚ÑŒ Ð½Ð°Ð¿Ñ€Ð°Ð²Ð»ÐµÐ½Ð¸Ðµ <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" style="margin-left: 4px; display: inline-block; vertical-align: middle;"><path d="m6 9 6 6 6-6"/></svg></label>
                            <div class="nx-dropdown__panel">
                                <div class="nx-dropdown__option" data-val="legal">Ð®Ñ€Ð¸Ð´Ð¸Ñ‡ÐµÑÐºÐ¾Ðµ ÑÐ¾Ð¿Ñ€Ð¾Ð²Ð¾Ð¶Ð´ÐµÐ½Ð¸Ðµ</div>
                                <div class="nx-dropdown__option" data-val="tax">ÐÐ°Ð»Ð¾Ð³Ð¾Ð²Ð¾Ðµ ÐºÐ¾Ð½ÑÑƒÐ»ÑŒÑ‚Ð¸Ñ€Ð¾Ð²Ð°Ð½Ð¸Ðµ</div>
                                <div class="nx-dropdown__option" data-val="audit">ÐÑƒÐ´Ð¸Ñ‚ Ð¸ Ð±ÑƒÑ…. ÑƒÑ‡ÐµÑ‚</div>
                                <div class="nx-dropdown__option" data-val="accounting">ÐÑƒÐ´Ð¸Ñ‚ Ð¸ Ð±ÑƒÑ…. ÑƒÑ‡ÐµÑ‚</div>
                                <div class="nx-dropdown__option" data-val="automation">ÐÐ²Ñ‚Ð¾Ð¼Ð°Ñ‚Ð¸Ð·Ð°Ñ†Ð¸Ñ Ð±Ð¸Ð·Ð½ÐµÑÐ°</div>
                                <div class="nx-dropdown__option" data-val="consulting">Ð‘Ð¸Ð·Ð½ÐµÑ-ÐºÐ¾Ð½ÑÐ°Ð»Ñ‚Ð¸Ð½Ð³</div>
                        ...
                        <div class="cta-crystal__field">
                            ...
                            <label for="m-f-msg">Ð¡ÑƒÑ‚ÑŒ Ð²Ð°ÑˆÐµÐ³Ð¾ Ð·Ð°Ð¿Ñ€Ð¾ÑÐ°</label>
                        </div>
